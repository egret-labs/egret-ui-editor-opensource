...
declare module egret {
     ...
     * @platform Web,Native
     */
    function registerClass(classDefinition: any, className: string, interfaceNames?: string[], toGlobal?: boolean): void;
}
...
declare module egret {
    ...
    */
    class Clipboard extends HashObject {
        /** [只读] 一个字符串数组，其中包含此 Clipboard 对象中的可用数据格式的名称。 */
        formats: Array<string>;
        /** [静态] [只读] 操作系统剪贴板。 */
        static generalClipboard: Clipboard;
        ...
        setData(format: string, data: any, serializable?: boolean): boolean;
        /** 添加对产生要传输的数据的处理函数的引用。 */
        setDataHandler(format: string, handler: Function, serializable?: boolean): boolean;
    }
}
declare module egret {
    class ClipboardFormats {
        /** [静态] 文件数组（仅限 AIR）。 */
        static FILE_LIST_FORMAT: string;
        /** [静态] HTML 数据。 */
        static HTML_FORMAT: string;
        /** [静态] RTF 格式数据。 */
        static RICH_TEXT_FORMAT: string;
        /** [静态] 字符串数据。 */
        static TEXT_FORMAT: string;
    }
}
declare module egret {
    class ClipboardTransferMode {
        /** [静态] Clipboard 对象应仅返回副本。 */
        static CLONE_ONLY: string;
        /** [静态] 如果可用，Clipboard 对象应返回副本；如果不可用，则返回引用。 */
        static CLONE_PREFERRED: string;
        /** [静态] Clipboard 对象应仅返回引用。 */
        static ORIGINAL_ONLY: string;
        /** [静态] 如果可用，Clipboard 对象应返回引用；如果不可用，则返回副本。 */
        static ORIGINAL_PREFERRED: string;
    }
}
declare module egret {
    /**
...
declare namespace egret {
    class Icon extends egret.EventDispatcher {
        bitmaps: Array<any>;
    }
}
declare namespace egret {
    class InteractiveIcon extends egret.Icon {
        bitmaps: Array<any>;
        width: number;
        height: number;
    }
...
declare module egret {
    class NativeDragActions extends HashObject {
        /** [静态] 定义用于复制操作的字符串。 */
        static COPY: string;
        /** [静态] 定义用于链接操作的字符串。 */
        static LINK: string;
...
declare module egret {
    ...
    *NativeDragManager 类协调拖放操作。使用本机拖放 API 可以使用户在 AIR 应用程序和本机操作系统之间、两个应用程序之间以及一个应用程序内不同组件之间拖动数据。
        ...
        AIR 配置文件支持：AIR for TV 设备不支持此功能。所有移动设备上也不支持它。您可以使用 NativeDragManager.isSupported 属性在运行时测试是否受支持。有关在多个配置文件之间支持 API 的详细信息，请参阅 AIR 配置文件支持。
        ...
        如果拖动目标只实现一个动作，则此对象可以设置 nativeDragEnter 和 nativeDragOver 事件处理函数中的 NativeDragManager 的 dropAction 属性。拖动之前设置该属性将允许拖动管理器更新鼠标指针，以表示支持的动作并防止用户使用功能键选择不兼容的动作。如果指定的动作不是允许的动作之一，则不允许拖动，即使目标调用 acceptDrop() 方法。
        ...
        拖动手势从调用 mouseDown 或 mouseMove 事件处理函数内的 NativeDragManager.doDrag() 方法开始，然后继续执行以下事件序列以响应用户动作：
        ...
        nativeDragEnter、nativeDragOver 事件 -- 当拖动手势越过交互式对象时，该对象将调度 nativeDragEnter 事件。当拖动手势停留在交互式对象上时，该对象将继续调度 nativeDragOver 事件。在响应这些事件中的任一事件时，作为潜在放置目标的对象应检查事件对象的属性，以确定它是否可以接受放置。如果数据格式和允许的动作适当，则这些事件的事件处理函数必须调用 NativeDragManager.acceptDrop()，传入对将作为拖动目标的显示对象（通常是调度 nativeDragEnter 或 nativeDragOver 事件的对象）的引用。然后用户可以将拖动项拖动到目标上。
        ...
        nativeDragComplete -- 当用户在拖动手势结束并释放鼠标时，启动器对象将调度 nativeDragComplete 事件（无论放置本身是否已完成）。此事件的处理函数可以检查事件对象的 dropAction 属性以确定应该对其内部数据状态进行何种修改（如果有），比如从列表中删除已拖动出去的项目。如果 dropAction 为 NativeDragActions.NONE，则拖动项目没有放到符合条件的目标上。
        应用程序之间的手势

        当拖动手势从非 AIR 应用程序进入 AIR 应用程序窗口时，不会有启动器对象调度 nativeDragStart 或 nativeDragComplete 事件。在该手势期间调度的事件将遵循与在同一 AIR 应用程序内开始和结束的手势相同的模式。

        当拖动手势离开 AIR 应用程序窗口时，不会有目标对象调度 nativeDragEnter、nativeDragOver 或 nativeDragDrop 事件。启动器对象仍将调度 nativeDragComplete 事件，该事件会报告由本机操作系统设置的拖动动作（如果不接受放置，则报告 none）。
    ...
    */
    interface NativeDragManagerClass {
         ...
         */
        acceptDragDrop(target: DisplayObject, accept?: boolean): void;
        /** [静态] 启动拖放操作。 */
        doDrag(dragInitiator: DisplayObject, clipboard: Clipboard, dragImage?: BitmapData, offset?: Point, allowedActions?: NativeDragOptions, dragStartEvent?: DragEvent, dragDomImage?: any, domOffset?: Point): void;
    }
    var NativeDragManager: NativeDragManagerClass;
}
declare module egret {
    class NativeDragOptions extends HashObject {
        $byte: number;
        /** 允许使用放置目标来复制拖动的数据。 */
        allowCopy: boolean;
        ...
        /** 允许使用放置目标来移动拖动的数据。 */
        allowMove: boolean;
        private setValue(value, flag);
        toString(): any;
        parseString(stringValue: string): any;
    }
    enum NativeDragOptionsFlag {
        copy = 1,
        link = 16,
        move = 256,
    }
...
declare module egret {
     ...
     */
    interface NativeMenuItem extends egret.EventDispatcher {
        /** 控制此菜单项是否显示复选标记。 */
        checked: boolean;
        /** 与此菜单项关联的任意数据对象。 */
        data: Object;
        ...
        /** 等效功能键的键控代码数组。 */
        keyEquivalentModifiers: Array<number>;
        /** 此菜单项的显示字符串。 */
        label: string;
        /** [只读] 包含此项目的菜单。 */
        menu: NativeMenu;
    ...
    interface NativeMenuItemConstructor {
        new (label?: string, isSeparator?: boolean, option?: NativeMenuItemOption): NativeMenuItem;
    }
    interface NativeMenuItemOption {
        icon?: string;
        keyEquivalent?: string;
        keyEquivalentModifiers?: number[];
    }
    var NativeMenuItem: NativeMenuItemConstructor;
}
declare module egret {
    /**
     *
     ...
     */
    interface NativeMenu extends egret.EventDispatcher {
        ...
        $parent: NativeMenu;
        /** 在菜单底部添加一个菜单项。 */
        addItem(item: NativeMenuItem): NativeMenuItem;
        /** 在指定位置插入一个菜单项。 */
        ...
        addSubmenuAt(submenu: NativeMenu, index: number, label: string): NativeMenuItem;
        /** 报告此菜单是否包含指定的菜单项。 */
        ...
        /** 获取具有指定名称的菜单项。 */
        getItemByName(name: string): NativeMenuItem;
        /** 获取指定项目的位置。 */
        getItemIndex(item: NativeMenuItem): number;
        /** 删除菜单中的所有项目。 */
        removeAllItems(): void;
        /** 删除指定的菜单项。 */
        removeItem(item: NativeMenuItem): NativeMenuItem;
        /** 删除并返回指定索引处的菜单项。 */
        removeItemAt(index: number): NativeMenuItem;
        /** 将菜单项移到指定位置。 */
        setItemIndex(item: NativeMenuItem, index: number): void;
    }
    interface NativeMenuConstructor {
        new (type?: string): NativeMenu;
        /** [静态] [只读] 表示客户端系统上是否支持任何形式的本机菜单。 */
        isSupported: boolean;
        TPYE_MENUBAR: string;
        addShortcuts(menu: egret.NativeMenu): any;
    }
    var NativeMenu: NativeMenuConstructor;
}
declare module egret.sys {
    /**
     * @private
...
declare module egret {
    ...
    class Stage extends DisplayObjectContainer {
         ...
         */
        focus: DisplayObject;
        $setFocus(target: DisplayObject, relatedObject?: DisplayObject, isMouse?: boolean, isKey?: boolean, shiftKey?: boolean, direction?: string, keyCode?: number): void;
        /**
...
declare module egret {
    ...
    class FocusEvent extends egret.Event {
        ...
        direction: string;
        keyCode: number;
        static dispatchFocusEvent(target: DisplayObject, type: string, relatedObject?: DisplayObject, shiftKey?: boolean, direction?: string, keyCode?: number): boolean;
    }
}
declare module egret {
    /**
...
declare module egret {
    class KeyboardEvent extends Event {
        ...
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, charCodeValue?: number, keyCodeValue?: number, keyLocationValue?: number, ctrlKeyValue?: boolean, altKeyValue?: boolean, shiftKeyValue?: boolean, controlKeyValue?: boolean, commandKeyValue?: boolean);
        /** [静态] KeyboardEvent.KEY_DOWN 常量定义 keyDown 事件对象的 type 属性的值。 */
        static KEY_DOWN: string;
        /** [静态] KeyboardEvent.KEY_UP 常量定义 keyUp 事件对象的 type 属性的值。 */
        static KEY_UP: string;
        static dispatchKeyboardEvent(target: IEventDispatcher, type: string, bubbles?: boolean, cancelable?: boolean, charCodeValue?: number, keyCodeValue?: number, keyLocationValue?: number, ctrlKeyValue?: boolean, altKeyValue?: boolean, shiftKeyValue?: boolean, controlKeyValue?: boolean, commandKeyValue?: boolean): boolean;
    }
}
declare module egret {
    /**
...
declare module egret {
    class MouseEvent extends egret.Event {
        /** @private temp point */
        static $localPoint: Point;
        ...
        static NONE_BUTTON: number;
        static MAIN_BUTTON: number;
        ...
        $localY: number;
        $clickCount: number;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, stageX?: number, stageY?: number, relatedObject?: DisplayObject, ctrlKey?: boolean, altKey?: boolean, shiftKey?: boolean, buttonDown?: boolean, delta?: number, commandKey?: boolean, controlKey?: boolean, clickCount?: number);
         ...
         * @private
         */
        $initTo(stageX: number, stageY: number): void;
        /**
         * @private
         */
        $stageX: number;
         ...
         * @platform Web,Native
         */
        static dispatchMouseEvent(target: IEventDispatcher, type: string, bubbles?: boolean, cancelable?: boolean, stageX?: number, stageY?: number, relatedObject?: DisplayObject, ctrlKey?: boolean, altKey?: boolean, shiftKey?: boolean, buttonDown?: boolean, deltaY?: number, commandKey?: boolean, controlKey?: boolean, clickCount?: number, deltaX?: number): boolean;
    }
}
declare module egret {
    class NativeDragEvent extends MouseEvent {
        ...
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, stageX?: number, stageY?: number, relatedObject?: DisplayObject, clipboard?: Clipboard, allowedActions?: NativeDragOptions, dropAction?: string, controlKey?: boolean, altKey?: boolean, shiftKey?: boolean, commandKey?: boolean);
        /** [静态] NativeDragEvent.NATIVE_DRAG_COMPLETE 定义 nativeDragComplete 事件对象的 type 属性值。 */
        static NATIVE_DRAG_COMPLETE: string;
        /** [静态] NativeDragEvent.NATIVE_DRAG_DROP 定义 nativeDragDrop 事件对象的 type 属性值。 */
        static NATIVE_DRAG_DROP: string;
        /** [静态] NativeDragEvent.NATIVE_DRAG_ENTER 定义 nativeDragEnter 事件对象的 type 属性值。 */
        static NATIVE_DRAG_ENTER: string;
        /** [静态] NativeDragEvent.NATIVE_DRAG_EXIT 定义 nativeDragExit 事件对象的 type 属性值。 */
        static NATIVE_DRAG_EXIT: string;
        /** [静态] NativeDragEvent.NATIVE_DRAG_OVER 定义 nativeDragOver 事件对象的 type 属性值。 */
        static NATIVE_DRAG_OVER: string;
        /** [静态] NativeDragEvent.NATIVE_DRAG_START 定义 nativeDragStart 事件对象的 type 属性值。 */
        static NATIVE_DRAG_START: string;
        /** [静态] NativeDragEvent.NATIVE_DRAG_UPDATE 定义 nativeDragUpdate 事件对象的 type 属性值。 */
        static NATIVE_DRAG_UPDATE: string;
        static dispatchDragEvent(target: IEventDispatcher, type: string, bubbles?: boolean, cancelable?: boolean, stageX?: number, stageY?: number, relatedObject?: DisplayObject, clipboard?: Clipboard, allowedActions?: NativeDragOptions, dropAction?: string, controlKey?: boolean, altKey?: boolean, shiftKey?: boolean, commandKey?: boolean): boolean;
    }
}
declare module egret {
    /**
...
declare module egret {
    ...
    /**
     * @language en_US
     * Create a new egret player on the target container
     */
    /**
     * @language zh_CN
     * 在指定容器中创建 egret player
     */
    function initPlayer(container: any): void;
}
declare module egret.sys {
    /**
     * @private
...
declare module egret {
    class Keyboard {
        ...
        /** [静态] 包含所有定义的键名称常量的数组。 */
        static CharCodestrings: Array<string>;
...
declare module egret.sys {
     ...
     * 用户交互操作管理器
     */
    class KeyboardHandler extends HashObject {
        /**
         * @private
         */
         ...
         * @param touchPointID 分配给触摸点的唯一标识号
         */
        onKeyDown(raw: KeyboardEventData): boolean;
        /**
         * @private
         * 按键开始（按下）
         * @param x 事件发生处相对于舞台的坐标x
         ...
         * @param touchPointID 分配给触摸点的唯一标识号
         */
        onKeyUp(raw: KeyboardEventData): boolean;
    }
}
declare namespace egret {
    class Mouse extends HashObject {
        /** [静态] 本机光标的名称。 */
...
declare namespace egret {
    class MouseCursor extends HashObject {
        /** [静态] 用于指定应使用箭头光标。 */
        static ARROW: string;
        ...
        static MOVE: string;
        /** 禁止 Drop */
        static NO_DROP: string;
        /** 禁止操作 */
        static NOT_ALLOWED: string;
        /** 任意滚动 */
        static ALL_SCROLL: string;
        /** 调整列宽 */
        static COL_RESIZE: string;
        /** 调整行高 */
        static ROW_RESIZE: string;
        /** 水平缩放 */
        static EW_RESIZE: string;
        /** 竖向缩放 */
        static NS_RESIZE: string;
        /** 右上左下缩放 */
        static NESW_RESIZE: string;
        /** 左上右下缩放 */
        static NWSE_RESIZE: string;
        /** 放大 */
...
declare namespace egret {
     ...
     */
    class MouseCursorData extends HashObject {
        /** 包含光标图像URL。 */
        data: Array<string>;
        /** 包含光标图像URL。 */
        data2x: Array<string>;
...
declare module egret.sys {
     ...
     * 用户交互操作管理器
     */
    class MouseHandler extends HashObject {
        private maxTouches;
         ...
         * @param touchPointID 分配给触摸点的唯一标识号
         */
        onMouseDown(x: number, y: number, touchPointID: number, raw: MouseEventData): void;
        /**
         * @private
         * 触摸开始（按下）
         * @param x 事件发生处相对于舞台的坐标x
         ...
         * @param touchPointID 分配给触摸点的唯一标识号
         */
        onMouseWheel(x: number, y: number, touchPointID: number, raw: MouseEventData): void;
        /**
         * @private
         */
        private lastTouchX;
         ...
         * @param touchPointID 分配给触摸点的唯一标识号
         */
        onMouseMove(x: number, y: number, touchPointID: number, raw: MouseEventData): void;
        onMouseLeave(x: number, y: number, touchPointID: number, raw: MouseEventData): void;
        /**
         * @private
         * 触摸结束（弹起）
         * @param x 事件发生处相对于舞台的坐标x
         ...
         * @param touchPointID 分配给触摸点的唯一标识号
         */
        onMouseUp(x: number, y: number, touchPointID: number, raw: MouseEventData): void;
        /**
         * @private
         * 获取舞台坐标下的触摸对象
         */
        protected findTarget(stageX: number, stageY: number): DisplayObject;
        private dispatchMouseEvent(target, type, raw, stageX?, stageY?, relatedObject?, bubbles?, count?);
        protected findRollOutOverChain(oldTarget: egret.DisplayObject, newTarget: DisplayObject): [DisplayObject[], DisplayObject[]];
        private getCursorOfTarget(target);
...
declare module egret {
    ...
    class InputController extends HashObject {
         ...
         */
        blurHandler(): void;
        private onMouseOverHandler(event);
        private onMouseDownHandler(event);
        private onMouseOutHandler(event);
...
declare module egret {
    /** 根据修饰键名称取得键值 */
    function modifiersToCode(modifiers: string): number[];
    /** 根据修饰键键值取得名称 */
    function codeToModifiers(modifiers: number[], toUpperCase?: boolean): string;
}
declare module egret {
    /**
     * @version Egret 2.4
...
declare module egret {
    function stageToWindow(stage: Stage, stageX: number, stageY: number): Point;
}
declare module egret {
    /**
     * @language en_US
...
declare type WebMouseEvent = MouseEvent;
declare module egret.web {
    /**
     * @private
     */
    class WebKeyboardHandler extends HashObject {
        /**
         * @private
         */
        constructor(stage: egret.Stage, container: HTMLElement);
        /**
         * @private
         */
        private container;
