declare module eui {
     ...
     * @author featherJ
     */
    class TreeDragBehavior {
        private onDragInComplete;
        private onDragInCompleteThis;
        /**
         * 设置一个拖拽进入完成的回调函数
         * @param callback
         * @param thisObject
         */
        setOnDragInComplete(callback: Function, thisObject: any): void;
        private onDragMoveComplete;
        private onDragMoveCompleteThis;
        /**
         * 设置一个拖拽移动完成的回调函数
         * @param callback
         * @param thisObject
         */
        setOnDragMoveComplete(callback: Function, thisObject: any): void;
        private onDragStart;
        private onDragStartThis;
        /**
         * 设置一个拖拽开始
         * @param callback
         * @param thisObject
         */
        setOnDragStart(callback: Function, thisObject: any): void;
        private _stage;
        private _tree;
        private _dragable;
        private shapeSelect;
        private shapeSelectRoot;
        private acceptFunction;
        private acceptThisObject;
        /**
         * 得到接收拖拽的目标项，如果为空则默认为当前鼠标所指向的项。  accpetFunctionHandler(obj:Object):Object
         * @param callback
         * @param thisObject
         */
        setAcceptFunc(callback: Function, thisObject: any): void;
        private canDragFunction;
        private canDragThisObject;
        /**
         * 目标项是否可以拖拽，形式如canDragFunction(dragItems:Array):Boolean
         * @param callback
         * @param thisObject
         */
        setCanDragFunc(callback: Function, thisObject: any): void;
        private canDropInFunction;
        private canDropInThisObject;
        /**
         * 是否可以释放拖拽进入。(dropTarget:Object,dragItems:Array):Boolean
         * @param callback
         * @param thisObject
         */
        setCanDropInFunc(callback: Function, thisObject: any): void;
        private canDropMoveFunction;
        private canDropMoveThisObject;
        /**
         ...
         * @param thisObject
         */
        setCanDropMoveFunc(callback: Function, thisObject: any): void;
        private _orderable;
        private rootSelectOffsetY;
        constructor();
        /**
         * 初始化一棵树
         * @param tree
         */
        init(tree: Tree): void;
        private addedToStage_handler(e);
        private removeFromStage_handler(e);
        private isDataGroupMouseIn;
        private dataGroupRollOverHandler(event);
        private dataGroupRollOutHandler(event);
        /**
         * 是否可以拖拽
         */
        dragable: boolean;
        private addedToStageHandler(event);
        private treeStageMouseMoveHandler(event);
        private isTreeMouseIn;
        private updateRootSelect();
        /**
         * 是否支持拖拽改变顺序
         */
        orderable: boolean;
        private treeMouseDownHandler(event);
        private treeMouseUpHandler(event);
        private dragItems;
        private _isDraging;
        private _dragStage;
        private parentFolder;
        private startDragHandler(event);
        /**
         * 排序选择项
         * @param items
         * @retur
         */
        private sortSelectedItems(items);
        private _startMouseY;
        private adjustVPosHandler(event);
        ...
        private canDropIn;
        private canDropMove;
        private itemDragMouseOverHandler(event?);
        /**
         * 得到指定项的高度，把子项也算进去了
         * @param itemRenderer
         * @return
         */
        private getRenderHeightInSameLevel(itemRenderer);
        private getItemRenderByData(data);
        protected itemDragMouseOutHandler(event: egret.MouseEvent): void;
        protected dragMouseUpHandler(event: egret.MouseEvent): void;
        /**
         * 完成拖拽
         * @param $parentFolder
         * @param $dragItemsnumber
         */
        doDrag($parentFolder: any, $dragItems: any[]): void;
        /**
         * 完成移动
         * @param $parentFolder
         * @param $dragItems
         */
        doMove($currentData: any, $dragItems: any[], isTop: boolean): void;
        /**
         * 检查相同项
         * @param source
         * @param target
         * @return
         */
        private checkSameObj(source, target);
        private deleteFrom(arr, target);
        private itemRenderList;
        rendererRemoved(renderer: IItemRenderer): void;
        rendererAdded(renderer: IItemRenderer): void;
        /**
         * 通过内容得到渲染项
         * @param data
         * @return
         */
        private getItemByData(data);
        /**
         * 判断是否是子类
         * @param parent
         * @param children
        ...
        *
         */
        private checkIsChildren(parents, child);
        private drawDropIn(renderer);
        private drawDropMove(renderer, isTop?);
    }
}
declare module eui {
    /**
...
declare module eui {
    ...
    interface ITreeCollection extends ICollection {
         ...
         */
        expandItem(item: any, open?: boolean): any;
        /**
         * 获取节点的深度
         * @param item
         * @returns
...
declare module eui {
     ...
     * @author featherJ
     */
    class ObjectCollection extends egret.EventDispatcher implements ICollection, ITreeCollection {
...
declare module eui {
    class AccordionGroup extends eui.Group {
        constructor();
        accordionButtonSkinClass: any;
        accordionButtonClass: typeof eui.ToggleButton;
        layout: eui.LayoutBase;
        private createChildrenCalled;
        protected createChildren(): void;
        private elementsContentChanged;
        private _elementsContent;
        getElementsContent(): Array<any>;
        elementsContent: Array<UIComponent>;
        private setElementsContent(value);
        numElements: number;
        getElementAt(index: number): UIComponent;
        private checkForRangeError(index, addingElement?);
        addChild(element: UIComponent): UIComponent;
        addChildAt(element: UIComponent, index: number): UIComponent;
        removeChild(element: UIComponent): UIComponent;
        removeChildAt(index: number): UIComponent;
        removeChildren(): void;
        getChildIndex(element: UIComponent): number;
        setChildIndex(element: UIComponent, index: number): void;
        swapChildren(element1: UIComponent, element2: UIComponent): void;
        swapChildrenAt(index1: number, index2: number): void;
        private childAdded(element, index, notifyListeners?);
        private childRemoved(element, index, notifyListeners?);
        static errorStr: string;
        private onButtonChange(event);
    }
}
declare module eui {
    /**
...
declare module eui {
     ...
     *此类用于应用程序的入口类
     */
    class Application extends UILayer {
        constructor();
        protected createChildren(): void;
        private focusManager;
        private addedToStageHandle(e);
        private removeFromStageHandle(e);
    }
}
declare module eui.sys {
    /**
...
declare module eui {
    ...
    class Button extends Component {
         ...
         */
        protected touchCaptured: boolean;
        /**
         * @language en_US
        ...
        protected onMouseRollOver(event: egret.MouseEvent): void;
        protected onMouseRollOut(event: egret.MouseEvent): void;
        /**
         * @inheritDoc
         *
         * @version Egret 2.4
...
declare module eui {
     ...
     *
     */
    class AutoToggleButton extends eui.ToggleButton {
        constructor();
        autoSelected: boolean;
        protected buttonReleased(): void;
    }
...
declare module eui {
    class BoxContainer extends eui.Group implements eui.UIComponent, eui.IBoxElement {
        constructor(_isDoc?: boolean);
        private _elementId;
        elementId: number;
        private _isDoc;
        /**
         ...
         * 拖拽关联的TabGroup
         */
        private dragingTabGroup;
        /**
         * 拖拽的TabPanel索引，如果为-1则表示拖拽TabGroup
         */
        private dragingIndex;
        private oldMouseChildren;
        private dragShape;
        private startPoint;
        /**
         * 开始拖拽
         */
        private startDragPanel(target, index?);
        instanceFunc: (clazz: any) => eui.TabGroup;
        /**
         * 拖拽窗口完成
         */
        private onDragMouseUp(event);
        private dragMoved;
        private onDragMouseMove(event);
        protected commitProperties(): void;
        ...
        private dropIndex;
        reorderOnly: boolean;
        private redrawDragShape();
        private adjustRect(rect, innerRect, curX, curY, fraction);
        private getTabRectUnderMouse(tabGroup);
        private _ownerBox;
        /**
         * 所属的盒式容器
         */
        ownerBox: eui.IBoxElement;
        ...
        private _parentBox;
        parentBox: eui.IBoxElementContainer;
        private _minimized;
        /**
         * 是否处于最小化状态
         */
        minimized: boolean;
        private explicitVisible;
        visible: boolean;
        parentBoxChanged(box: eui.IBoxElementContainer, checkOldParent?: boolean): void;
        /**
         * 在根节点旁添加一个盒式元素
         * @param box 要添加的盒式元素
         * @param position 插入位置，只能从容器的四个边缘插入元素。请使用AddPosition定义的常量。
         */
        addElement(box: eui.IBoxElement, position?: string): eui.IBoxElement;
        /**
         * 添加盒式元素到指定位置
         * @param box 要添加的盒式元素
         ...
         */
        addElementAt(box: eui.IBoxElement, relativeBox: eui.IBoxElement, position?: string): eui.IBoxElement;
        /**
         * 移除一个盒式元素
         */
        removeElement(box: eui.IBoxElement): eui.IBoxElement;
        /**
         * 添加元素到显示列表
         */
        private addBoxElement(box);
        /**
         * 子项visible属性发生改变
         */
        private onVisibleChanged(event);
        /**
         * 初始化分隔符
         */
        private initSeparator(separator);
        /**
         * 从显示列表移除元素
         */
        private removeBoxElement(box);
        /**
         * 销毁分隔符
         */
        private destorySeparator(separator);
        private offsetX;
        private offsetY;
        private firstHasDoc;
        private secondHasDoc;
        private isVertical;
        private curBox;
        /**
         * 鼠标按下
         */
        private startResizePanel(separator);
        private onMouseUp(event);
        /**
         * 调整盒子元素大小
         */
        private onMouseMove(event);
        private setExplicitWidth(box, w);
        private setExplicitHeight(box, h);
        private _documentBox;
        documentBox: eui.BoxContainer;
        private _rootBox;
        /**
         * 容器根元素
         */
        rootBox: eui.IBoxElement;
        protected updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
        /**
         * 缩放时的最小尺寸
         */
         ...
         * 更新子项的尺寸和位置
         */
        updateChildElement(child: eui.IBoxElement): void;
        /**
         * 检查指定的元素是否包含或等于documentBox
         */
        private hasDocument(box);
    }
}
declare module eui {
    /**
...
declare module eui {
    class ColorPicker extends eui.Component {
        ...
        protected onClear(event: egret.Event): void;
        protected onCancel(event: egret.Event): void;
        protected onConfirm(event: egret.Event): void;
        private onColorPicked(event);
        colorDisplay: eui.Rect;
...
declare module eui {
    class ColorWindow extends eui.Panel {
        constructor();
        protected onKeyDown(event: egret.KeyboardEvent): void;
        private _liveChange;
        liveChange: boolean;
        private _currentColor;
        currentColor: number;
        ...
        private _defaultColor;
        defaultColor: number;
        private _pickerTarget;
        pickerTarget: egret.DisplayObject;
        private onRemoveTarget(event?);
        private onPickerTargetMouse(event);
        private onPickerTargetOut(event);
        private saturationCircle;
        private saturationAreaData;
        private hueLine;
        private hueSlider;
        private hueLineData;
        private saturationUI;
        private saturationGroup;
        private currentColorArea;
        private lastColorArea;
        private rTextInput;
        private gTextInput;
        private bTextInput;
        private rgbTextInput;
        private focusUi;
        private defaultButton;
        private confirmButton;
        private cancelButton;
        protected partAdded(partName: string, instance: any): void;
        private closeHandle(e);
        protected createChildren(): void;
        protected onRGBTextInputFocusOut(event: egret.FocusEvent): void;
        protected onTextInputFocusOut(event: egret.FocusEvent): void;
        private rgbTextInputing;
        protected onRGBTextChange(event: egret.Event): void;
        private textInputing;
        protected onTextChange(event: egret.Event): void;
        protected onLastColorClick(event: egret.MouseEvent): void;
        private hoverd;
        private onRollOut(event);
        private onRollOver(event);
        private currentHueIndex;
        private setHueSlider(color);
        private setSaturationCirclePos(color);
        private onSaturationMouseDown(event);
        private onMouseUp(event);
        onMouseMove(event: egret.MouseEvent): void;
        private onHueSliderChange(event);
        protected onCloseButtonClick(event?: egret.TouchEvent): void;
        private onDefaultClick(event);
        private onConfirmClick(event?);
        private doLivingChange();
        private setRGBValue(color);
        private drawCurrentColor(color);
        private drawLastColor(color);
        private drawMask(mask, color, rotation?);
        private drawHueLine();
        private getColor(r, g, b);
        private getHue(color);
        private getSaturation(color);
        private getLightness(color);
        private Hsv2Rgb(h, s, v);
        private drawSaturation(color);
    }
}
declare module eui {
    class DataGrid extends eui.Component {
        private updateHoverOnRollOver;
        alternatingRowColorsBackground: any;
        caretIndicator: any;
        columnHeaderGroup: eui.GridColumnHeaderGroup;
        columnSeparator: any;
        editorIndicator: any;
        grid: eui.Grid;
        hoverIndicator: any;
        ...
        private alternatingRowColorsChanged;
        private _alternatingRowColors;
        constructor();
        private _selectedByKeyboard;
        /**
         * 能否使用键盘来控制选中项
         */
        selectedByKeyboard: boolean;
        protected keyDown_handler(event: egret.KeyboardEvent): void;
        /**
         * 滚动数据项以使其可见的简便处理方法
         */
        ensureIndexIsVisible: (index: number) => void;
        private initGridHead(e);
        /**
         * 舞台大小产生改变之后，如果新的大小大于滚动区则复原滚动位置
         */
        private onResize_handler(event);
        alternatingRowColors: Array<any>;
        protected commitProperties(): void;
        private initializeGridRowBackground();
        private deferredGridOperations;
        static partPropertyBits: any;
        private gridProperties;
        static gridPropertyDefaults: any;
        private static getPartProperty(part, properties, propertyName, defaults);
        private static setPartProperty(part, properties, propertyName, value, defaults);
        private getGridProperty(propertyName);
        private setGridProperty(propertyName, value);
        editOnMouseUp: boolean;
        doubleClickTime: number;
        editKey: number;
        editOnDoubleClick: boolean;
        editor: eui.DataGridEditor;
        private dispatchChangeEvent(type);
        private dispatchUIEvent(type);
        columns: eui.ICollection;
        private getColumnAt(columnIndex);
        columnsLength: number;
        dataProvider: eui.ICollection;
        dataProviderLength: number;
        dataTipField: string;
        ...
        enableIME: boolean;
        private _gridSelection;
        protected gridSelection: eui.GridSelection;
        private _itemEditor;
        itemEditor: any;
        itemEditorInstance: eui.IGridItemEditor;
        itemRenderer: any;
        ...
        requestedMinRowCount: number;
        requestedMinColumnCount: number;
        ...
        focusOwner: eui.Component;
        private focusOwnerWidth;
        private focusOwnerHeight;
        protected createChildren(): void;
        $onAddToStage(stage: egret.Stage, nestLevel: number): void;
        tabIndex: number;
        protected updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
        setFocus(): void;
        private isOurFocus(target);
        private scrollerEvent;
        protected keyDownHandler(event: any): void;
        protected selectAllHandler(event: egret.Event): void;
        private selectAllFromKeyboard();
        private initializeDataGridElement(elt);
        protected partAdded(partName: string, instance: any): void;
        protected partRemoved(partName: string, instance: any): void;
        selectedCell: eui.CellPosition;
        selectedCells: Array<eui.CellPosition>;
        selectedIndex: number;
        selectedIndices: Array<number>;
        selectedItem: any;
        selectedItems: Array<Object>;
        selectionLength: number;
        invalidateCell(rowIndex: number, columnIndex: number): void;
        selectAll(): boolean;
        /**
         * @param dispatchChangeEvent 清空选择是否抛出事件，默认是抛出事件
         */
        clearSelection(dispatchChangeEvent?: boolean): boolean;
        selectionContainsIndex(rowIndex: number): boolean;
        selectionContainsIndices(rowIndices: Array<number>): boolean;
        /**
         * 由程序或者用户设置选中项。
         * @param rowIndex 索引值。
         * @param dispatchChangeEvent 当索引值发生改变，且该参数为true的时候，组件派发事件。
         */
        setSelectedIndex(rowIndex: number, dispatchChangeEvent?: boolean): boolean;
        addSelectedIndex(rowIndex: number, dispatchChangeEvent?: boolean): boolean;
        removeSelectedIndex(rowIndex: number): boolean;
        selectIndices(rowIndex: number, rowCount: number): boolean;
        selectionContainsCell(rowIndex: number, columnIndex: number): boolean;
        selectionContainsCellRegion(rowIndex: number, columnIndex: number, rowCount: number, columnCount: number): boolean;
        setSelectedCell(rowIndex: number, columnIndex: number): boolean;
        addSelectedCell(rowIndex: number, columnIndex: number): boolean;
        removeSelectedCell(rowIndex: number, columnIndex: number): boolean;
        selectCellRegion(rowIndex: number, columnIndex: number, rowCount: number, columnCount: number): boolean;
        protected commitInteractiveSelection(selectionEventKind: string, rowIndex: number, columnIndex: number, rowCount?: number, columnCount?: number): boolean;
        protected commitCaretPosition(newCaretRowIndex: number, newCaretColumnIndex: number): void;
        createGridSelection(): eui.GridSelection;
        protected selectionContainsOnlyIndex(index: number): boolean;
        protected selectionContainsOnlyIndices(selectionChange: eui.CellRegion): boolean;
        private selectionContainsOnlyCell(rowIndex, columnIndex);
        private selectionContainsOnlyCellRegion(rowIndex, columnIndex, rowCount, columnCount);
        startItemEditorSession(rowIndex: number, columnIndex: number): boolean;
        endItemEditorSession(cancel?: boolean): boolean;
        createEditor(): eui.DataGridEditor;
        sortByColumns(column: eui.GridColumn, isInteractive?: boolean): boolean;
        private isAnchorSet();
        private toggleSelection(rowIndex, columnIndex);
        private extendSelection(caretRowIndex, caretColumnIndex);
        private setSelectionAnchorCaret(rowIndex, columnIndex);
        private setCaretToNavigationDestination(navigationUnit);
        ensureCellIsVisible(rowIndex: number, columnIndex?: number): void;
        protected adjustSelectionUponNavigation(event: any): boolean;
        private doesChangeCurrentSelection(selectionEventKind, selectionChange);
        protected grid_rollOverHandler(event: eui.GridEvent): void;
        protected grid_rollOutHandler(event: eui.GridEvent): void;
        protected grid_mouseUpHandler(event: eui.GridEvent): void;
        protected grid_mouseDownHandler(event: eui.GridEvent): void;
        protected grid_caretChangeHandler(event: eui.GridCaretEvent): void;
        protected grid_valueCommitHandler(event: eui.UIEvent): void;
        private grid_invalidateDisplayListHandler(event);
        private grid_invalidateSizeHandler(event);
        private resizeColumn;
        private resizeAnchorX;
        private resizeColumnWidth;
        private nextColumn;
        private nextColumnWidth;
        protected columnHeaderGroup_clickHandler(event: eui.GridEvent): void;
        protected separator_mouseDownHandler(event: eui.GridEvent): void;
        protected separator_mouseDragHandler(event: eui.GridEvent): void;
        protected separator_mouseUpHandler(event: eui.GridEvent): void;
        protected separator_rollOverHandler(event: eui.GridEvent): void;
        protected separator_rollOutHandler(event: eui.GridEvent): void;
        protected dataGrid_focusHandler(event: egret.FocusEvent): void;
    }
}
declare module eui {
    /**
...
declare module eui {
    class DividedGroup extends eui.Component {
        constructor();
        dividerLine: any;
        dividerGroup: eui.Group;
        protected dividers: Array<any>;
        protected cursorName: string;
        addChild(euic: eui.UIComponent): egret.DisplayObject;
        private createDivider(firstChild, secondChild, index?);
        private recycleDivider(index);
        private getDividerIndex(divider);
        protected updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
        protected layoutDivider(divider: eui.UIComponent, prev: eui.UIComponent, next: eui.UIComponent): void;
        private onDividerMouseOver(e);
        private onDividerMouseOut(e);
        private onDividerMouseDown(e);
        private onDividerMouseUp(e);
        protected activeDivider: any;
        protected dragUI: eui.UIComponent;
        protected startDividerDrag(e: egret.MouseEvent): void;
        protected stopDividerDrag(e: egret.MouseEvent): void;
        protected applyDrag(e: egret.MouseEvent): void;
        protected dragMove(e: egret.MouseEvent): void;
    }
}
declare module eui {
    /**
    ...
    class DropDownList extends eui.Component {
        ...
        itemRendererSkinName: any;
        itemRendererFunction: any;
        private openButton;
        private _dataProvider;
        dataProvider: any;
        labelDisplay: egret.TextField;
        private labelChanged;
        private popUpAnchor;
        private _prompt;
        prompt: string;
        private _promptChanged;
        protected commitProperties(): void;
        list: eui.List;
        protected partAdded(partName: string, instance: any): void;
        private openClickHandle(e);
        private stageClickHandle(e);
        private itemTapHandle(e);
        private changedHandler(e);
        updateLabelDisplay(displayItem?: any): void;
        private _labelField;
        labelField: string;
        itemToLabel(item: any): string;
        private _setSelectIndex;
        /**
         * 外部设置的选中项下标
         */
        private _setSelectItem;
        selectedItem: any;
    }
}
declare module eui {
     ...
     *
     */
    class DocDropDownList extends DropDownList {
        constructor();
        private _label;
        /**
         * 显示的文字
...
declare module eui {
     ...
     * 选项卡组
     */
    class TabGroup extends eui.Component implements eui.IBoxElement {
        constructor();
        protected onClose(event: eui.TabGroupEvent): void;
        /**
         * 当前持有焦点的TabGroup
         */
        static currentFocusTabGroup: eui.TabGroup;
        /**
         * 是否是焦点面板
         */
        private _isFocus;
        protected onFocusOut(event?: egret.FocusEvent): void;
        protected onFocusIn(event: egret.FocusEvent): void;
        protected measure(): void;
        protected valdateNow(): void;
        validateProperties(): void;
        validateSize(): void;
        protected getCurrentState(): string;
        /**
         ...
         * 项呈示器实例到item的引用
         */
        private hashToRendererMap;
        private rendererToItemMap;
        /**
         * 添加一个面板
         * @param panel 添加的面板实例
         ...
         */
        addElement(panel: eui.ITabPanel): void;
        /**
         * 添加一个面板
         * @param panel 添加的面板实例
         * @param index 要添加到的位置 , -1 表示添加到末尾
         * @param data 面板的数据，不设置则默认使用面板的data属性。
         */
        addElementAt(panel: eui.ITabPanel, index?: number, data?: any): void;
        /**
         * 移除指定位置的元素
         */
        removeElementAt(index: number): eui.ITabPanel;
        /**
         * 移除一个面板
         */
        removeElement(panel: eui.ITabPanel): void;
        /**
         * 未设置缓存选中项的值
         */
        ...
        selectedPanel: eui.ITabPanel;
        /**
         * 获取指定位置的面板，如果不存在则立即创建
         */
        getElementAt(index: number): eui.ITabPanel;
        private _panelRenderer;
        /**
         * 用于创建Panel的呈示器。该类必须实现 ITabPanel 接口。
         */
        panelRenderer: any;
        private _panelRendererFunction;
        /**
         * 创建ITabPanel的函数， 示例 panelRendererFunction(data:Object):Class
         */
        panelRendererFunction: Function;
        private _labelField;
        /**
         * 显示标题的字段
         */
         ...
         * 提交选中项  , 是否派发值提交事件
         */
        protected commitSelection(newIndex: number, dispatch?: boolean): void;
        /**
         * 为特定的数据项返回项呈示器类定义
         */
        private itemToRendererClass(item);
         ...
         */
        private createOneRenderer(item);
        private createOneRenderer2(rendererClass);
        protected updateRenderer(renderer: eui.ITabPanel, itemIndex: number, data: any): eui.ITabPanel;
        setFocus(): void;
         ...
         * 双击标题
         */
        private onTitleDoubClick(event);
        protected onTabBarValueCommit(event: PropertyEvent): void;
        /**
         * 改变时马上提交选中的标志
         */
        private hasCommit;
         ...
         * 鼠标点击选中项改变
         */
        protected onTabBarIndexChanged(event: egret.Event): void;
        /**
         * 鼠标点击选中项即将改变
         */
        protected onTabBarIndexChanging(event: egret.Event): void;
        private tabMenu;
        protected onMenuMouseDown(event: egret.MouseEvent): void;
        private createMenu(labelList);
        private onMenuSelect(event);
        /**
         * 用户操作关闭index处的面板
         */
        protected onClosePanel(index: number, direct?: boolean): void;
        protected updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
        private cachePanel;
        protected updateTitleGroup(): void;
        /**
         * 将标题栏工具组的内容放到TabGroup里
         */
        private pushTitleGroupToTabGroup(panel);
        /**
         * 将标题栏工具组的内容放回到TabPanel里
         */
        private pushTitleGroupToTabPanel(panel);
        /**
         * 将工具头的图标按钮全部推回tabpanel。
         *
         */
        private pushTitleGroupBack(panel);
    }
}
declare module eui {
    /**
     ...
     */
    class DocTabGroup extends eui.TabGroup {
        constructor();
        protected onFocusIn(event: egret.FocusEvent): void;
        /**
         * 文档要显示的Panel对象
         */
        private documentRenderer(data);
        /**
         * 添加一个文档
         */
        addDocument(document: eui.IDocumentData): void;
        /**
         * 移除一个文档
         * @param document 要移除的对象
         * @param dispatch 随后是否派发事件
         */
        removeDocument(document: eui.IDocumentData, dispatch?: boolean, direct?: boolean): void;
        /**
         * 选中的文档数据
         */
        selectedDocument: eui.IDocumentData;
        /**
         * 获取指定位置的文档
         */
        getDocumentAt(index: number): eui.IDocumentData;
        /**
         * 获取文档的位置
         */
        getDocumentIndex(value: eui.IDocumentData): number;
        private dataProviderChangedSub;
        dataProvider: eui.ArrayCollection;
        protected commitProperties(): void;
        /**
         * 添加一项
         ...
         * 添加文档数据属性
         */
        private addDocumentPropery(item);
        /**
         * 移除文档数据属性
         */
        private removeDocumentPropery(item);
        private lastDocument;
        protected commitSelection(newIndex: number, dispatch?: boolean): void;
        /**
         * [SkinPart] 显示标签个数的下拉框
         */
        tabDropDown: DocDropDownList;
        protected partAdded(partName: string, instance: any): void;
        /**
         * 关闭标签
         */
        private onTabClose(event);
        /**
         * 关闭其他
         */
        protected onTabCloseOther(event: egret.Event): void;
        /**
         * 关闭全部
         */
        protected onTabCloseAll(event: egret.Event): void;
        /**
         * 正在关闭面板
         */
        protected onClosingPanel(event: eui.TabGroupEvent): void;
        /**
         * 面板关闭了
         */
        protected onClosedPanel(event: eui.TabGroupEvent): void;
        /**
         * 创建了一个文档
         */
        protected onPanelCreated(event: eui.TabGroupEvent): void;
        /**
         * 选中了下拉框中的项
         */
        protected onSelectDropDown(event: egret.Event): void;
        /**
         * 下拉框打开
         */
        protected dropDownOpen(event: eui.UIEvent): void;
        protected updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
        /**
         * 显示的最大标签数
         */
        private _maxTabElement;
        /**
         * 缓存面板的数组， 越在数组前面表示越是最近打开的。
         */
        private cacheDataArray;
        /**
         * 刷新TitleBar上显示的元素
         */
        private updateTitleBarElement();
    }
}
declare module eui {
    /**
...
declare module eui {
     ...
     *
     */
    class DownListItemRenderer extends ItemRenderer {
        constructor();
...
declare module eui {
    class DragDisplay extends eui.Group {
        private _dataArr;
        private maxSize;
        constructor(dataArr: Array<any>);
        protected createChildren(): void;
        private label;
        setData(_data: Array<any>): void;
    }
}
declare module eui.sys {
    /**
...
declare module eui {
    class Grid extends eui.Group implements eui.IDataGridElement {
        private deferredOperations;
        private caretSelectedItem;
        inUpdateDisplayList: boolean;
        ...
        private dispatchChangeEvent(type);
        private dispatchUIEvent(type);
        private _anchorColumnIndex;
        private anchorChanged;
        anchorColumnIndex: number;
        private _anchorRowIndex;
        anchorRowIndex: number;
        private _caretIndicator;
        caretIndicator: any;
        private _caretColumnIndex;
        private _oldCaretColumnIndex;
        private caretChanged;
        caretColumnIndex: number;
        private _caretRowIndex;
        private _oldCaretRowIndex;
        caretRowIndex: number;
        private _hoverIndicator;
        hoverIndicator: any;
        private _hoverColumnIndex;
        ...
        private dataProviderChanged;
        dataProvider: eui.ICollection;
        private _dataTipField;
        dataTipField: string;
        private _dataTipFunction;
        dataTipFunction: Function;
        private _itemRenderer;
        private itemRendererChanged;
        itemRenderer: any;
        private _columnSeparator;
        columnSeparator: any;
        private _gridSelection;
        gridSelection: eui.GridSelection;
        private _dataGrid;
        dataGrid: eui.DataGrid;
        preserveSelection: boolean;
        private _requestedMaxRowCount;
        requestedMaxRowCount: number;
        private _requestedMinRowCount;
        requestedMinRowCount: number;
        private _requestedRowCount;
        requestedRowCount: number;
        private _requestedMinColumnCount;
        requestedMinColumnCount: number;
        ...
        resizableColumns: boolean;
        private _rowBackground;
        rowBackground: any;
        private _rowHeight;
        private rowHeightChanged;
        rowHeight: number;
        private setFixedRowHeight(value);
        ...
        selectionLength: number;
        selectionMode: string;
        private _showDataTips;
        showDataTips: boolean;
        private _typicalItem;
        private typicalItemChanged;
        typicalItem: any;
        invalidateTypicalItemRenderer(): void;
        private _variableRowHeight;
        private variableRowHeightChanged;
        variableRowHeight: boolean;
        selectAll(): boolean;
        /**
         * @param dispatchChangeEvent 清空选择是否抛出事件，默认是抛出事件
        ...
        private scrollToIndex(elementIndex, scrollHorizontally, scrollVertically);
        ensureCellIsVisible(rowIndex?: number, columnIndex?: number): void;
        getVisibleRowIndices(): Array<number>;
        getVisibleColumnIndices(): Array<number>;
        getCellBounds(rowIndex: number, columnIndex: number): egret.Rectangle;
        getRowBounds(rowIndex: number): egret.Rectangle;
        getColumnBounds(columnIndex: number): egret.Rectangle;
        getRowIndexAt(x: number, y: number): number;
        getColumnIndexAt(x: number, y: number): number;
        getColumnWidth(columnIndex: number): number;
        getCellAt(x: number, y: number): eui.CellPosition;
        getCellsAt(x: number, y: number, w: number, h: number): Array<eui.CellPosition>;
        getCellX(rowIndex: number, columnIndex: number): number;
        getCellY(rowIndex: number, columnIndex: number): number;
        getItemRendererAt(rowIndex: number, columnIndex: number): eui.IGridItemRenderer;
        isCellVisible(rowIndex?: number, columnIndex?: number): boolean;
        private invalidateDisplayListReasonsMask;
        static invalidateDisplayListReasonBits: any;
        private setInvalidateDisplayListReason(reason);
        isInvalidateDisplayListReason(reason: string): boolean;
        clearInvalidateDisplayListReasons(): void;
        invalidateSize(): void;
        invalidateDisplayList(): void;
        protected commitProperties(): void;
        private lastUnscaledWidth;
        private lastUnscaleHeight;
        protected updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
        invalidateDisplayListFor(reason: string): void;
        invalidateCell(rowIndex: number, columnIndex: number): void;
        createGridSelection(): eui.GridSelection;
        private getGridColumn(columnIndex);
        getDataProviderItem(rowIndex: number): any;
        private getVisibleItemRenderer(rowIndex, columnIndex);
        private rollRowIndex;
        private rollColumnIndex;
        private mouseDownRowIndex;
        private mouseDownColumnIndex;
        private lastClickTime;
        DOUBLE_CLICK_TIME: number;
        protected grid_mouseDownDragUpHandler: (event: egret.MouseEvent) => void;
        protected grid_mouseMoveHandler: (event: egret.MouseEvent) => void;
        protected grid_mouseRollOutHandler: (event: egret.MouseEvent) => void;
        protected grid_mouseUpHandler: (event: egret.MouseEvent) => void;
        private dispatchGridClickEvents(mouseEvent, gridXY, rowIndex, columnIndex);
        private dispatchGridEvent(mouseEvent, type, gridXY, rowIndex, columnIndex);
        private updateCaretForDataProviderChange(event);
        private updateCaretForColumnsChange(event);
        private updateHoverForDataProviderChange(event);
        private updateHoverForColumnsChange(event);
        private dataProvider_collectionChangeHandler(event);
        private columns_collectionChangeHandler(event);
        clearGridLayoutCache(clearTypicalSizes: boolean): void;
        getNextVisibleColumnIndex(index?: number): number;
        getPreviousVisibleColumnIndex(index: number): number;
        private initializeAnchorPosition(columnOnly?);
        private initializeCaretPosition(columnOnly?);
        private dispatchCaretChangeEvent();
    }
}
declare module eui {
    class GridColumnHeaderGroup extends eui.Group implements eui.IDataGridElement {
        constructor();
        private createCompeletFun(e);
        ...
        private _separatorAffordance;
        separatorAffordance: number;
        private dispatchChangeEvent(type);
        private _columnSeparator;
        columnSeparator: any;
        private _dataGrid;
        dataGrid: eui.DataGrid;
        private grid_changeEventHandler(event);
        private _downColumnIndex;
        downColumnIndex: number;
        private _headerRenderer;
        itemRenderer: any;
        private _hoverColumnIndex;
        hoverColumnIndex: number;
        private _visibleSortIndicatorIndices;
        visibleSortIndicatorIndices: Array<number>;
        isSortIndicatorVisible(columnIndex: number): boolean;
        getHeaderIndexAt(x: number, y: number): number;
        getSeparatorIndexAt(x: number, y: number): number;
        getHeaderRendererAt(columnIndex: number): eui.IGridItemRenderer;
        getHeaderBounds(columnIndex: number): egret.Rectangle;
        private rollColumnIndex;
        private rollSeparatorIndex;
        private pressColumnIndex;
        private pressSeparatorIndex;
        protected gchg_mouseDownDragUpHandler: (event: egret.MouseEvent) => void;
        protected gchg_mouseMoveHandler: (event: egret.MouseEvent) => void;
        protected gchg_mouseRollOutHandler: (event: egret.MouseEvent) => void;
        protected gchg_clickHandler(event: egret.MouseEvent): void;
        protected gchg_doubleClickHandler(event: egret.MouseEvent): void;
        private dispatchGridEvent(mouseEvent, type, headerGroupXY, columnIndex);
        private getColumnAt(columnIndex);
    }
}
declare module eui {
    class HDividerGroup extends eui.DividedGroup {
        constructor();
        protected cursorName: string;
        private _minElementWidth;
        minElementWidth: number;
        protected layoutDivider(divider: eui.UIComponent, prev: eui.UIComponent, next: eui.UIComponent): void;
        protected dividerStartX: number;
        protected dragStartX: number;
        protected startDividerDrag(e: egret.MouseEvent): void;
        protected dragMove(e: egret.MouseEvent): void;
        protected applyDrag(e: egret.MouseEvent): void;
        horizontalLayout: eui.LayoutBase;
    }
}
declare module eui.sys {
    /**
...
declare module eui {
    ...
    class SliderBase extends Range {
         ...
         */
        pendingValue: number;
        protected setPendingValue(value: number): void;
        /**
         * @inheritDoc
         *
         * @version Egret 2.4
...
declare module eui {
     ...
     *
     */
    class PopUpSliderBase extends eui.SliderBase {
        constructor();
        private _isDragging;
        isDragging: boolean;
        protected onRelease(event: eui.TrackBaseEvent): void;
        protected onPress(event: eui.TrackBaseEvent): void;
        textInput: eui.TextInput;
        dropDown: egret.DisplayObject;
        openButton: eui.Button;
        private _dropDownController;
        protected dropDownController: eui.DropDownController;
        isDropDownOpen: boolean;
        openDropDown(): void;
        closeDropDown(commit: boolean): void;
        private _labelFunction;
        labelFunction: Function;
        private promptChanged;
        private _promptValue;
        promptValue: number;
        protected getCurrentState(): string;
        protected partAdded(partName: string, instance: any): void;
        private onTextInputFocusOut(event);
        dropDownController_openHandler(event: eui.UIEvent): void;
        open_updateCompleteHandler(event: eui.UIEvent): void;
        protected dropDownController_closeHandler(event: eui.UIEvent): void;
        private close_updateCompleteHandler(event);
        protected stage_mouseWheelHandler(event: egret.TouchEvent): void;
        protected setValue(value: number): void;
        protected commitProperties(): void;
        private _isPrompt;
        isPrompt: boolean;
        updatePromptValue(newValue?: number): void;
...
declare module eui {
     ...
     *
     */
    class HPopUpSlider extends eui.PopUpSliderBase {
        constructor();
        protected pointToValue(x: number, y: number): number;
        /**
          * @private
...
declare module eui {
     ...
     * @platform Web,Native
     */
    class ScrollBarBase extends SliderBase {
        /**
         * @language en_US
         * Constructor.
         * @version Egret 2.4
...
declare module eui {
    class HueSlider extends eui.VSlider {
        constructor();
        private isMouseDown;
        protected onTrackTouchBegin(event: any): void;
        private startThumbDrag(event);
        private system_mouseUpSomewhereHandler(event);
    }
}
declare module eui {
    interface ICollectionView extends eui.ICollection {
        sort(compareFunction?: Function): any;
        sortOn(fieldName: string, options: any): any;
        filterFunction: Function;
    }
}
declare module eui {
     ...
     *
     */
    interface IDataGridElement extends eui.IInvalidating {
        dataGrid: eui.DataGrid;
    }
}
declare module eui {
...
declare module eui {
    interface IDocumentData extends eui.IDataRenderer, egret.IEventDispatcher {
        clazz: any;
        path: string;
        owner: any;
    }
...
declare module eui {
    interface ILayoutElement extends egret.IEventDispatcher {
        includeInLayout: boolean;
        left: number;
        right: number;
        top: number;
        ...
        maxHeight: number;
        minHeight: number;
        setLayoutBoundsSize(width: number, height: number): any;
        setLayoutBoundsPosition(x: number, y: number): any;
        getMinBoundsWidth(postLayoutTransform?: boolean): number;
        getMinBoundsHeight(postLayoutTransform?: boolean): number;
        getMaxBoundsWidth(postLayoutTransform?: boolean): number;
        getMaxBoundsHeight(postLayoutTransform?: boolean): number;
    }
}
declare module eui {
    interface ITabPanel extends eui.UIComponent, eui.IDataRenderer {
        show: boolean;
        title: string;
        itemIndex: number;
        $owner: TabGroup;
...
declare module eui {
     ...
     *
     */
    interface IVisualElement extends eui.ILayoutElement {
        owner: any;
        ownerChanged(value: any): any;
        name: string;
        parent: egret.DisplayObjectContainer;
        visible: boolean;
        alpha: number;
...
declare module eui {
    ...
    class ListBase extends DataGroup {
         ...
         * @platform Web,Native
         */
        protected onRendererTouchBegin(event: egret.MouseEvent): void;
        /**
         * @language en_US
         ...
         * @platform Web,Native
         */
        protected onRendererTouchEnd(event: egret.MouseEvent): void;
        /**
         * @private
         * 触摸在舞台上结束
         */
...
declare module eui {
     ...
     * @author 图标选项卡组件
     */
    class IconTabBar extends TabBar {
        constructor();
        protected rendererAdded(renderer: IItemRenderer, index: number, item: any): void;
        updateRenderer(renderer: IItemRenderer, itemIndex: number, data: any): IItemRenderer;
        protected rendererRemoved(renderer: IItemRenderer, index: number, item: any): void;
        private item_mouseDownHandler(event);
    }
}
declare module eui {
    class IconTabBarButton extends eui.ItemRenderer {
        constructor();
...
declare module eui {
    ...
    class List extends ListBase {
        ...
        protected onRendererTouchEnd(event: egret.MouseEvent): void;
        protected onRendererTouchBegin(event: egret.MouseEvent): void;
        protected item_mouseMoveHandler(event: egret.MouseEvent): void;
        /**键盘事件 */
        protected keyDown_handler(event: egret.KeyboardEvent): void;
        /**
         * 列表的自动滚动
         ...
         */
        private autoScrollToIndex(nextSelectedIndex?);
        /**
         * 舞台大小产生改变之后，如果新的大小大于滚动区则复原滚动位置
         */
        private onResize_handler(event);
         ...
         * 通过键盘导航键调整选中项
         */
        protected adjustSelectionAndCaretUponNavigation(event: KeyboardEvent): void;
        private _keyboardUpAndDownLoop;
        /**
         * 是否up 、down 按键循环
         */
        keyboardUpAndDownLoop: boolean;
        /**
         * 滚动数据项以使其可见的简便处理方法
         */
        ensureIndexIsVisible(index: number): void;
...
declare module eui {
     ...
     */
    class NumberRegulator extends eui.Range {
        constructor();
        editableText: eui.TextInput;
        labelDisplay: egret.TextField;
        private promptChanged;
        private _promptValue;
        value: number;
        ...
        private _isPrompt;
        isPrompt: boolean;
        private _openLabelWheel;
        openLabelWheel: boolean;
        updatePromptValue(newValue?: number): void;
        protected partAdded(partName: string, instance: any): void;
        protected partRemoved(partName: string, instance: any): void;
        private labelDisplay_mouseWheelHandler(event);
        /**
         * 按 stepSize增大或减小当前值
         ...
         */
        stepSize: number;
        private labelDisplay_rollOutHandler(event);
        private labelDisplay_rollOverHandler(event);
        private editableText_mouseWheelHandler(event);
        private labelDisplay_mouseClickHandler(event);
        private isEditModel;
        protected enterEditMode(): void;
        private editableTextTextCommitHandler(event);
        private stage_mouseDownHandler(event);
        protected exitEditMode(save?: boolean): void;
        private syncTextInputValue(triggerEvent);
        private _isDragging;
        isDragging: boolean;
        private lastPoint;
        private lastValue;
        private labelDisplay_mouseDownHandler(event);
        protected stage_mouseMoveHandler(event: egret.MouseEvent): void;
        private hasUpdateValue;
        private updateWhenMouseMove();
        protected stage_mouseUpHandler(event: egret.MouseEvent): void;
        protected getCurrentState(): string;
        protected setValue(value: number): void;
    }
}
declare module eui {
    ...
    class PanelArea extends Group {
        ...
        protected onDocChanged(event: DocumentEvent): void;
        protected onDocFocusIn(event: DocumentEvent): void;
        /**
         * 派发选中文档改变的事件
         */
        private dispatchDocChange(newDocument);
        /**
         * 外层盒式布局容器
         */
         ...
         * 文档区域盒子
         */
        documentBox: BoxContainer;
        /**
         * 文档选项卡组，如果存在多个的情况取最新的那个
         */
        documentGroup: DocTabGroup;
        private getDocment(box);
        private quickGroup;
        private separator;
        /**是否响应TabBar双击事件 true 响应  false 禁用*/
        tabDoubleClickEnabled: boolean;
        protected createChildren(): void;
        private onMinimizedChanged(event);
        private onTabGroupEvent(event);
        private closeBox(targetBox, target?);
        private maximizedBox(targetBox);
        private restoreList;
        private restorePanels();
        private refreshRestoreList();
        /**
         * 鼠标经过
         */
        private onSepRollOver(event);
        /**
         * 鼠标移出
         */
        private onSepRollOut(event);
        private offsetY;
        private onSepMouseDown(event);
        private panelHeightDic;
        private onSepMouseUp(event);
        private onSepMouseMove(event);
        private onBoxContainerMouseDown(event);
        private oldPanelIndex;
        private oldParent;
        private quickPanel;
        /**
         * 关闭当前弹出的快速窗口
         */
        private closeQuickPanel();
        /**
         * 窗口布局数据
         */
        contentXML: egret.XML;
        private _contentXML;
        getContentXML(ignoreSize: boolean): egret.XML;
        createXMLByPanel(box: any, ignoreSize?: boolean): egret.XML;
        classMap: any;
        instancePanelFunc: (name: string) => IVisualElement;
        instanceFunc: (clazz: any) => any;
        /**
         * 从xml数据实例化窗口列表
         */
        private createPanelByXML(value);
        /**
         * 刷新数据
         */
        destory(): void;
         ...
         * 根据窗口标题获取窗口引用
         */
        getPanelByTitle(title: string): TabPanel;
        private findPanel(box, title);
        /**
         * 添加一个文档窗口
         */
        addDocument(documentData: IDocumentData): void;
        /**
         * 添加一个普通窗口
         */
        addTabPanel(panel: TabPanel): void;
        private findTabGroup(box);
        private minimizedChanged;
        private invalidateMinimized();
        protected commitProperties(): void;
        /**
         * 更新最小化窗口列表
         */
        private updateMinimized(box);
    }
}
declare module eui {
    /**
     ...
     * @author dom
     */
    class PopUpAnchor extends eui.Component {
        /**
         * 构造函数
         */
        constructor();
         ...
         * 要弹出或移除的目标显示对象。
         */
        popUp: eui.UIComponent;
        private mouseDownHandler(e);
        private _popUpPosition;
        private _popUpPositionAdjust;
        /**
...
declare module eui {
    ...
    class Scroller extends Component {
        ...
        protected getDeltaX(event: egret.MouseEvent): number;
        protected getDeltaY(event: egret.MouseEvent): number;
        /**
         * @private
         *
         * @param event
         ...
         */
        protected partAdded(partName: string, instance: any): void;
        protected onHScrollBarChange(): void;
        protected onVScrollBarChange(): void;
    }
}
declare module eui {
    /**
...
declare module eui {
    class TabBarButton extends eui.ToggleButton implements eui.IItemRenderer {
        constructor();
...
declare module eui {
    class TabPanel extends eui.Component implements eui.ITabPanel {
        constructor();
        titleGroup: eui.Group;
        gapLine: eui.Rect;
        private _show;
         ...
         */
        addToContentGroup(child: egret.DisplayObject): void;
        show: boolean;
        protected dataChanged(): void;
        protected showChanged(): void;
        protected partAdded(partName: string, instance: any): void;
        private _itemIndex;
        itemIndex: number;
        private _icon;
...
declare module eui {
     ...
     *
     */
    class TextInputPro extends TextInput {
        constructor();
        bgUnselect: Image;
        bgSelect: Image;
        /**
         * 焦点移入
         */
        private focusIn_handler(event);
        /**
         * 焦点移
         */
        private focusOut_handler(event);
    }
}
declare module eui {
    /**
...
declare module eui {
     ...
     * @author featherJ
     */
    class TreePro extends Tree {
        private _treeDragBehavior;
        constructor();
        treeDragBehavior: TreeDragBehavior;
        private onDragInComplete(drop, dragItems);
        private onDragMoveComplete(drop, dragItems, isTop);
        protected dragFinalStartHandler(event: MouseEvent): void;
        private onDragStart(dragItems);
        protected rendererAdded(renderer: IItemRenderer, index: number, item: any): void;
        protected rendererRemoved(renderer: IItemRenderer, index: number, item: any): void;
        orderable: boolean;
        dragable: boolean;
         ...
         */
        setCanDropMoveFunction(callback: Function, thisObject: any): void;
        /**
         * 是否可以释放拖拽进入。(dropTarget:Object,dragItems:Array):Boolean
         */
        setCanDropInFunction(callback: Function, thisObject: any): void;
        /**
         * 得到接收拖拽的目标项，如果为空则默认为当前鼠标所指向的项。  accpetFunctionHandler(obj:Object):Object
         */
        setAcceptFunction(callback: Function, thisObject: any): void;
        /**
         * 目标项是否可以拖拽，形式如canDragFunction(dragItems:Array):Boolean
         */
        setCanDragFunction(callback: Function, thisObject: any): void;
        private _doubleClickExpand;
        /**
         * 是否在双击时自动展开或者关闭节点，此属性只有在doubleClickEnabled为true才有效
         */
        doubleClickExpand: boolean;
        private doubleClickHandler(event);
        /**按下的按键列表*/
...
declare module eui {
    class BoxElement extends egret.EventDispatcher implements eui.IBoxElementContainer {
        constructor(vertical?: boolean);
        _separator: eui.Separator;
        separator: eui.Separator;
        private _elementId;
        elementId: number;
        private _ownerBox;
        ownerBox: eui.IBoxElement;
        ...
        private _isVertical;
        isVertical: boolean;
        private _percentSize;
        percentSize: number;
        private _firstElement;
        firstElement: eui.IBoxElement;
        private _secondElement;
        secondElement: eui.IBoxElement;
        private _parentBox;
        parentBox: eui.IBoxElementContainer;
        parentBoxChanged(box: eui.IBoxElementContainer, checkOldParent?: boolean): void;
        private _x;
...
declare module eui {
    class FocusTabBarButton extends eui.IconTabBarButton {
        constructor();
        private _isFocus;
        isFocus: boolean;
        protected getCurrentState(): string;
...
declare module eui {
     ...
     * @author featherJ
     */
    class CloseTabButton extends eui.FocusTabBarButton {
        constructor();
        protected middleClickHandler(event: egret.TouchEvent): void;
        private tabMenu;
        protected rightClickHandler(event: egret.MouseEvent): void;
        private createMenu(labelList);
        /**
         * 菜单被点击
         */
        ...
        protected partAdded(partName: string, instance: any): void;
        protected partRemoved(partName: string, instance: any): void;
        private onCloseButtonDown(event);
        /**
         * 点击了关闭按钮
         */
...
declare module eui {
    interface IBoxElement extends egret.IEventDispatcher {
        elementId: number;
        x: number;
        y: number;
        width: number;
        ...
        defaultWidth: number;
        defaultHeight: number;
        setLayoutSize(width: number, height: number): any;
        parentBox: eui.IBoxElementContainer;
        parentBoxChanged(box: eui.IBoxElementContainer, checkOldParent?: boolean): any;
        ownerBox: eui.IBoxElement;
        isFirstElement: boolean;
        minimized: boolean;
        visible: boolean;
...
declare module eui {
    interface IBoxElementContainer extends eui.IBoxElement {
        firstElement: eui.IBoxElement;
        secondElement: eui.IBoxElement;
    }
}
declare module eui {
    class Separator extends eui.Group {
        constructor();
        target: any;
        /**
         * @private
...
declare module eui {
    ...
    interface IInvalidating {
        ...
        invalidateSize(): any;
        invalidateDisplayList(): any;
        validateNow(skipDisplayList?: boolean): any;
    }
}
declare module eui {
    class NavigationUnit extends egret.HashObject {
        static HOME: number;
        static END: number;
        static UP: number;
        static DOWN: number;
        ...
        static ENTER: number;
        static isNavigationUnit(keyCode: number): boolean;
    }
}
declare module eui {
    class PopUpPosition extends egret.HashObject {
        /**
        * 在组件上方弹出
        */
        static ABOVE: string;
...
declare module eui {
     ...
     *
     */
    class Dialog extends eui.Panel {
        static defaultTitleIcon: Object;
        constructor();
        /**
         * 按钮名称以及对应的实例
         */
         ...
         * 获取指定id的按钮
         */
        getButton(id: string): eui.Button;
        protected _returnCode: number;
        /**
         * 窗口的返回代码
         */
        returnCode(): number;
         ...
         * 对应名称按钮按下
         */
        protected buttonPressed(name: string): void;
        /**
         * 确定按钮按下
         */
         ...
         * 对话框区域
         */
        dialogArea: eui.Group;
        /**
         * 按钮组
         */
        buttonBar: eui.Group;
        protected partAdded(partName: string, instance: any): void;
        protected createButtonsForButtonBar(): void;
        protected createButton(id: string, label?: string, isDefault?: boolean): eui.Button;
        private onButtonClick(event);
        private defaultButton;
        /**
         * 设置默认按钮
         */
        setDefaultButton(button: eui.Button): void;
        protected onCloseButtonMouseEventClick(event?: egret.MouseEvent): void;
        protected onKeyDown(event: egret.KeyboardEvent): void;
    }
    class DialogConstants {
         ...
         * 取消按钮id
         */
        static CANCEL_ID: string;
        /**
         * 是按钮id
         */
        static YES_ID: string;
        /**
         * 否按钮id
         */
        static NO_ID: string;
         ...
         * 恢复默认
         */
        static DEFAULFS_ID: string;
        /**
         * 应用
         */
        static APPLY_ID: string;
        /**
         * 上一步
         */
        static BACK_ID: string;
        /**
         * 下一步
         */
        static NEXT_ID: string;
        /**
         * 完成
         */
        static FINISH_ID: string;
        /**
         * 无消息
         */
        static NONE: number;
...
declare module eui {
     ...
     *
     */
    class DialogPage extends eui.Group {
        constructor();
         ...
         * 设置消息以及类型
         */
        setMessage(value: string, type?: number): void;
...
declare module eui {
     ...
     *
     */
    interface IDialogPage extends eui.UIComponent {
        /**
         * 描述文本
         */
        getDescription(): string;
...
declare module eui {
    ...
    class InputDialog extends Dialog {
         ...
         * 输入文本的组件
         */
        protected textInput: eui.TextInput;
        /**
         * 显示提示消息的组件
         */
         ...
         * 显示错误的文本
         */
        protected errorMessageLabel: eui.Label;
        protected buttonPressed(name: string): void;
        protected childrenCreated(): void;
        protected createButtonsForButtonBar(): void;
        protected partAdded(partName: string, instance: any): void;
...
declare module eui {
     ...
     *
     */
    class MessageDialog extends eui.Dialog {
        constructor(dialogTitle?: string, dialogMessage?: string, buttonLabels?: string[], defaultIndex?: number);
        /**
     * 打开对话框
     */
        static openDialog(kind: number, title: string, message: string): MessageDialog;
        private static getButtonLabels(kind);
        private _message;
        /**
         * 文本
         */
         ...
         * 获取指定位置的Button
         */
        getButtonAt(index: number): eui.Button;
        protected buttonPressed(name: string): void;
        /**
         * 显示文本的组件
         */
        messageLabel: eui.Label;
        /**
         * 显示图片的组件
         */
        ...
        private buttonArrs;
        private defaultButtonIndex;
        protected createButtonsForButtonBar(): void;
    }
    class MessageDialogConstants {
        /**
         * 错误对话框，带有一个确定按钮
         */
        static ERROR: number;
...
declare module eui {
     ...
     *
     */
    class PageChangeEvent extends egret.Event {
        /**
        * 页面发生改变的事件
        */
         ...
         * 之前的页面
         */
        oldPage: eui.IDialogPage;
        /**
         * 新的页面
         */
        newPage: eui.IDialogPage;
        constructor(type: string, oldPage?: IDialogPage, newPage?: IDialogPage);
    }
}
declare module eui {
    /**
    ...
    class TitleAreaDialog extends Dialog {
         ...
         * 提示消息的类型标示图标
         */
        messageImage: eui.Image;
        private _titleAreaTitle;
        /**
         * 标题区的标题
         */
        titleAreaTitle: string;
         ...
         * 设置消息以及类型
         */
        setMessage(newMessage: string, newType: number): void;
        protected commitProperties(): void;
        /**
         * 更新消息文本
         */
        private updateMessage(newMessage);
        protected partAdded(partName: string, instance: any): void;
    }
}
declare module eui {
    class CellPosition extends egret.HashObject {
...
declare module eui {
    class CellRegion extends egret.HashObject {
        constructor(rowIndex?: number, columnIndex?: number, rowCount?: number, columnCount?: number);
...
declare module eui {
     ...
     *
     */
    class ColumnSeparator extends Component {
        constructor();
    }
}
declare module eui {
    class DataGridEditor extends egret.HashObject {
        constructor(dataGrid: eui.DataGrid);
        private doubleClickTimer;
        private gotDoubleClickEvent;
        private gotFlexEnterEvent;
        private lastEvent;
        private lastItemClickedPosition;
        private lastItemDown;
        private lastEditedItemPosition;
        private _dataGrid;
        dataGrid: eui.DataGrid;
        grid: eui.Grid;
        private _editedItemPosition;
        editedItemPosition: any;
        private setEditedItemPosition(coord);
        private inEndEdit;
        itemEditorInstance: eui.IGridItemEditor;
        private _editedItemRenderer;
        editedItemRenderer: eui.IVisualElement;
        editorColumnIndex: number;
        editorRowIndex: number;
        initialize(): void;
        uninitialize(): void;
        destroyItemEditor(): void;
        defaultDataGridItemEditor: any;
        createItemEditor(rowIndex: number, columnIndex: number): void;
        private wasLastEventMovingBackward();
        startItemEditorSession(rowIndex: number, columnIndex: number): boolean;
        endItemEditorSession(cancel?: boolean): boolean;
        cancelEdit(): void;
        private dispatchCancelEvent();
        private endEdit();
        private saveItemEditorSession();
        private openEditorInNextEditableCell(rowIndex, columnIndex, backward);
        private getNextEditableCell(rowIndex, columnIndex, backward);
        private canEditColumn(columnIndex);
        private wasCellPreviouslySelected(rowIndex, columnIndex);
        private isValidCellPosition(rowIndex, cellIndex);
        private addRemoveUIEventEnterListener(element, addListener);
        private editorOwnsClick(event);
        private editorOwns(child);
        private getIUIComponent(displayObject);
        private dataGrid_gridItemEditorSessionStartingHandler(event);
        private dataGrid_keyboardDownHandler(event);
        private grid_gridMouseDownHandler(event);
        private grid_gridMouseUpHandler(event);
        private grid_gridDoubleClickHandler(event);
        private doubleClickTimerHandler(event);
        private deactivateHandler(event);
        private editor_focusOutHandler(event);
        private editor_enterHandler(event);
        private editor_keyDownHandler(event);
        private editorAncestorResizeHandler(event);
        private sandBoxRoot_mouseDownHandler(event);
    }
}
declare module eui {
    class GridItemEditor extends eui.Component {
        constructor();
        private _owner;
        owner: any;
        ownerChanged(value: any): void;
        private _column;
        column: eui.GridColumn;
        columnIndex: number;
        private _data;
        data: any;
        /**
        ...
        enableIME: boolean;
        private _itemRenderer;
        itemRenderer: eui.IGridItemRenderer;
        private _rowIndex;
        rowIndex: number;
        private _value;
        value: any;
        ...
        private mouseUpDownMoveHandler(event);
        private mouseMoveHandler(event);
    }
}
declare module eui {
    class DefaultGridItemEditor extends eui.GridItemEditor {
        constructor();
 ...
 */
declare module eui {
    class EditorIndicator extends eui.Component {
        constructor();
    }
}
declare module eui {
    class GridColumn extends egret.EventDispatcher {
        static ERROR_TEXT: string;
        static _defaultItemEditor: any;
        static defaultItemEditor: any;
        defaultItemEditor: any;
        private static dataFieldPathSortCompare(obj1, obj2, column);
        constructor(columnName?: string);
        private _grid;
        setGrid(value: eui.Grid): void;
        grid: eui.Grid;
        private _columnIndex;
        setColumnIndex(value: number): void;
        columnIndex: number;
        private _dataField;
        private dataFieldPath;
        dataField: string;
        private _dataTipField;
        dataTipField: string;
        private _dataTipFunction;
        ...
        private _sortable;
        sortable: boolean;
        private _sortCompareFunction;
        sortCompareFunction: Function;
        private _sortDescending;
        sortDescending: boolean;
        private _visible;
        visible: boolean;
        private itemToString(item, labelPath, labelFunction);
        itemToLabel(item: any): string;
        itemToDataTip(item: any): string;
        itemToRenderer(item: any): any;
        private dispatchChangeEvent(type);
...
declare module eui {
    ...
    class LayoutBase extends egret.EventDispatcher {
         ...
         */
        getNavigationDestinationIndex(currentIndex: number, navigationUnit: number): number;
        /**
         * 计算所需的 verticalScrollPosition 和 horizontalScrollPosition delta，以将处于指定索引处的元素滚动到视图中
         */
        getScrollPositionDeltaToElement(index: number): egret.Point;
        /**
         * 返回指定索引元素的矩形。
         * 如果索引无效、相应的元素为 null、includeInLayout=false，或者如果此布局的 target 属性为 null，
         * 则将指定元素的布局界限返回为 Rectangle 或 null。
         */
        getElementBounds(index: number): egret.Rectangle;
        /**
         * 返回布局坐标中目标的滚动矩形的界限。
         */
        protected getScrollRect(): egret.Rectangle;
        /**
 ...
 */
         ...
         */
        protected getElementBoundsAboveScrollRect(scrollRect: egret.Rectangle): egret.Rectangle;
        /**
         * 返回跨越 scrollRect 的底边或在其底边之下的第一个布局元素的界限。
         */
        protected getElementBoundsBelowScrollRect(scrollRect: egret.Rectangle): egret.Rectangle;
    }
}
declare module eui {
    class GridColumnHeaderGroupLayout extends eui.LayoutBase {
        constructor();
        private rendererLayer;
        private overlayLayer;
        private rendererHeights;
        private maxRendererHeight;
        private visibleRenderersBounds;
        private visibleHeaderRenderers;
        private visibleHeaderSeparators;
        private freeElementMap;
        private elementToFactoryMap;
        target: eui.Group;
        useVirtualLayout: boolean;
        clearVirtualLayoutCache(): void;
        scrollPositionChanged(): void;
        ...
        getHeaderBounds(columnIndex: number): egret.Rectangle;
        getHeaderRendererAt(columnIndex: number): eui.IGridItemRenderer;
        private initializeItemRenderer(renderer, columnIndex, column, visible?);
        private createdVisualElement;
        private createVisualElement(factory);
        private allocateVisualElement(factory);
        private freeVisualElement(element);
        private updateRendererHeights(inUpdateDisplayList?);
        private columnHeaderGroup;
        private grid;
        private _columns;
        private columns;
        private columns_collectionChangeHandler(event);
        private columns_collectionChangeAdd(event);
        private columns_collectionChangeRemove(event);
        private columns_collectionChangeMove(event);
    }
}
declare module eui {
    class GridData extends egret.HashObject {
        ...
        computeSize(view: eui.ILayoutElement, wHint: number, hHint: number): void;
        flushCache(): void;
    }
}
declare module eui {
    class GridDimensions extends egret.HashObject {
        static insertElementsToVector(vec: Array<number>, startIndex: number, elements: Array<number>): void;
        static insertValueToVector(vec: Array<number>, startIndex: number, count: number, value: number): void;
        static clearVector(vec: Array<number>, value: number, startIndex?: number, count?: number): void;
        private static bound(a, min, max);
        private rowList;
        ...
        private startY2;
        private recentNode2;
        private typicalCellWidths;
        private typicalCellHeights;
        private maxTypicalCellHeight;
        private useMaxTypicalCellHeight;
        constructor();
        private _rowCount;
        rowCount: number;
        private _columnCount;
        ...
        getCellBounds(row: number, col: number): egret.Rectangle;
        getCellX(row: number, col: number): number;
        getCellY(row: number, col: number): number;
        private getPrevYAt(row, startNode, startY);
        private getNextYAt(row, startNode, startY);
        getRowBounds(row: number): egret.Rectangle;
        getPadRowBounds(row: number): egret.Rectangle;
        getColumnBounds(col: number): egret.Rectangle;
        getRowIndexAt(x: number, y: number): number;
        private isYInRow(y, startY, node);
        private getPrevRowIndexAt(y, startNode, startY);
        private getNextRowIndexAt(y, startNode, startY);
        getColumnIndexAt(x: number, y: number): number;
        getContentWidth(columnCountOverride?: number): number;
        getContentHeight(rowCountOverride?: number): number;
        getTypicalContentWidth(columnCountOverride?: number): number;
        getTypicalContentHeight(rowCountOverride?: number): number;
        getTypicalCellWidth(columnIndex: number): number;
        setTypicalCellWidth(columnIndex: number, value: number): void;
        getTypicalCellHeight(columnIndex: number): number;
        setTypicalCellHeight(columnIndex: number, value: number): void;
        clearTypicalCellWidthsAndHeights(): void;
        ...
        removeColumns(startColumn: number, count: number): void;
        clearRows(startRow: number, count: number): void;
        clearColumns(startColumn: number, count: number): void;
        moveRows(fromRow: number, toRow: number, count: number): void;
        moveColumns(fromCol: number, toCol: number, count: number): void;
        clearHeights(): void;
        private insertRowsAt(startRow, count, nodes?);
        private removeRowsAt(startRow, count);
        dataProviderCollectionChanged(event: eui.CollectionEvent): void;
        columnsCollectionChanged(event: eui.CollectionEvent): void;
        private columns_visibleChangedHandler(pcEvent);
        toString(): string;
    }
}
declare module eui {
    class GridItemRenderer extends eui.Component {
        labelDisplay: egret.TextField;
        private _label;
        static initializeRendererToolTip(renderer: eui.IGridItemRenderer): void;
        private _owner;
        owner: any;
        ownerChanged(value: any): void;
        static toolTipShowHandler(event: eui.ToolTipEvent): void;
        constructor();
        label: string;
        private _column;
        column: eui.GridColumn;
...
declare module eui {
    class GridLayer extends eui.Group {
        constructor();
        invalidateDisplayList(): void;
        invalidateSize(): void;
    }
...
declare module eui {
    class GridRowList extends egret.HashObject {
        private _head;
        private _tail;
        private _length;
        private recentNode;
        constructor();
        first: eui.GridRowNode;
        last: eui.GridRowNode;
        tail: eui.GridRowNode;
        head: eui.GridRowNode;
        length: number;
        private _numColumns;
        numColumns: number;
        insert(index: number): eui.GridRowNode;
        insertAfter(node: eui.GridRowNode, newNode: eui.GridRowNode): void;
        insertBefore(node: eui.GridRowNode, newNode: eui.GridRowNode): void;
        find(index: number): eui.GridRowNode;
        private findAfter(index, node);
        private findBefore(index, node);
        findNearestLTE(index: number): eui.GridRowNode;
        private findNearestLTEAfter(index, node);
        private findNearestLTEBefore(index, node);
        push(node: eui.GridRowNode): void;
        remove(index: number): eui.GridRowNode;
        removeNode(node: eui.GridRowNode): void;
        removeAll(): void;
        insertColumns(startColumn: number, count: number): void;
        removeColumns(startColumn: number, count: number): void;
        moveColumns(fromCol: number, toCol: number, count: number): void;
        clearColumns(startColumn: number, count: number): void;
        toString(): string;
        toArray(): eui.ArrayCollection;
    }
}
declare module eui {
    class GridRowNode extends egret.HashObject {
        rowIndex: number;
        private cellHeights;
        maxCellHeight: number;
        fixedHeight: number;
        next: eui.GridRowNode;
        prev: eui.GridRowNode;
        constructor(numColumns: number, rowIndex: number);
        private _numColumns;
        numColumns: number;
        private updateMaxHeight();
        getCellHeight(index: number): number;
        setCellHeight(index: number, value: number): boolean;
        insertColumns(startColumn: number, count: number): void;
        moveColumns(fromCol: number, toCol: number, count: number): void;
        clearColumns(startColumn: number, count: number): void;
        removeColumns(startColumn: number, count: number): void;
...
declare module eui {
    class GridSelection extends egret.HashObject {
        private cellRegions;
        private selectedItem;
        private inCollectionHandler;
        constructor();
        private _grid;
        grid: eui.Grid;
        ...
        selectionMode: string;
        allCells(): Array<eui.CellPosition>;
        allRows(): Array<number>;
        selectAll(): boolean;
        removeAll(): boolean;
        containsRow(rowIndex: number): boolean;
        containsRows(rowsIndices: Array<number>): boolean;
        setRow(rowIndex: number): boolean;
        addRow(rowIndex: number): boolean;
        removeRow(rowIndex: number): boolean;
        setRows(rowIndex: number, rowCount: number): boolean;
        containsCell(rowIndex: number, columnIndex: number): boolean;
        containsCellRegion(rowIndex: number, columnIndex: number, rowCount: number, columnCount: number): boolean;
        setCell(rowIndex: number, columnIndex: number): boolean;
        addCell(rowIndex: number, columnIndex: number): boolean;
        removeCell(rowIndex: number, columnIndex: number): boolean;
        setCellRegion(rowIndex: number, columnIndex: number, rowCount: number, columnCount: number): boolean;
        private isRowSelectionMode();
        private isCellSelectionMode();
        private isColumnVisible(columnIndex);
        private getGridColumnsLength();
        private getGridDataProviderLength();
        private regionsContainCell(rowIndex, columnIndex);
        private ensureRequiredSelection();
        private removeSelection();
        protected validateIndex(index: number): boolean;
        protected validateIndices(indices: Array<number>): boolean;
        protected validateCell(rowIndex: number, columnIndex: number): boolean;
        protected validateCellRegion(rowIndex: number, columnIndex: number, rowCount: number, columnCount: number): boolean;
        protected validateRowRegion(rowIndex: number, rowCount: number): boolean;
        private internalSetCellRegion(rowIndex, columnIndex?, rowCount?, columnCount?);
        private internalAddCellRegion(rowIndex, columnIndex?, rowCount?, columnCount?);
        private internalAddCell(rowIndex, columnIndex?);
        private internalRemoveCell(rowIndex, columnIndex?);
        private getCellRegionsBounds();
        dataProviderCollectionChanged(event: eui.CollectionEvent): void;
        private dataProviderCollectionAdd(event);
        private handleRowAdd(insertIndex, insertCount?);
        private dataProviderCollectionMove(event);
        private dataProviderCollectionRefresh(event);
        private handleRefreshAndReset(event);
        private dataProviderCollectionRemove(event);
        private handleRowRemove(removeIndex, removeCount?);
        private dataProviderCollectionReplace(event);
        private dataProviderCollectionReset(event);
        private dataProviderCollectionUpdate(event);
        columnsCollectionChanged(event: eui.CollectionEvent): void;
        private columnsCollectionAdd(event);
        private handleColumnAdd(insertIndex, insertCount?);
        private columnsCollectionMove(event);
        private columnsCollectionRemove(event);
        private handleColumnRemove(removeIndex, removeCount?);
        private columnsCollectionRefresh(event);
        private columnsCollectionReset(event);
    }
}
declare module eui {
    class GridSelectionMode extends egret.HashObject {
        constructor();
        static NONE: string;
        static SINGLE_ROW: string;
        static MULTIPLE_ROWS: string;
        static SINGLE_CELL: string;
        static MULTIPLE_CELLS: string;
    }
}
declare module eui {
    /**
     ...
     *
     */
    class HeaderColumnSeparator extends Component {
        constructor();
    }
}
/**
 ...
 */
declare module eui {
    class HoverIndicator extends eui.Component {
        constructor();
    }
}
declare module eui {
    interface IGridItemEditor extends eui.IVisualElement {
        dataGrid: eui.DataGrid;
        column: eui.GridColumn;
        columnIndex: number;
        rowIndex: number;
...
declare module eui {
    interface IGridItemRenderer extends eui.IVisualElement {
        grid: eui.Grid;
        rowIndex: number;
        down: boolean;
        dragging: boolean;
        ...
        column: eui.GridColumn;
        columnIndex: number;
        prepare(hasBeenRecycled: boolean): any;
        discard(willBeRecycled: boolean): any;
    }
}
/**
 *
 ...
 */
declare module eui {
    class RowSeparator extends eui.Component {
        constructor();
    }
}
declare module eui {
     ...
     *
     */
    class SelectionIndicatorRect extends Component {
        constructor();
    }
}
declare module eui.sys {
...
declare module eui {
     ...
     * @author dom
     */
    class DropDownController extends egret.EventDispatcher {
        /**
         * 构造函数
         */
        constructor();
         ...
         */
        hitAreaAdditions: Array<egret.DisplayObject>;
        private _dropDown;
        /**
         * 下拉区域显示对象
         */
         ...
         * openButton上按下鼠标事件
         */
        openButton_buttonDownHandler(event: egret.Event): void;
        /**
         * openButton上鼠标经过事件
         */
        openButton_rollOverHandler(event: egret.MouseEvent): void;
        /**
         * openButton上鼠标移出事件
         */
         ...
         * 舞台上鼠标按下事件
         */
        stage_mouseDownHandler(event: egret.Event): void;
        /**
         * 舞台上鼠标移动事件
         */
        stage_mouseMoveHandler(event: egret.Event): void;
        /**
         * 舞台上鼠标弹起事件
         */
        stage_mouseUpHandler_noRollOverOpenDelay(event: egret.Event): void;
        /**
         * 舞台上鼠标弹起事件
         */
        stage_mouseUpHandler(event: egret.Event): void;
        /**
         * 舞台尺寸改变事件
         */
        stage_resizeHandler(event: egret.Event): void;
        /**
         * 舞台上鼠标滚轮事件
         */
...
declare module eui {
    ...
    class TreeItemRenderer extends ItemRenderer implements ITreeItemRenderer {
         ...
         */
        private disclosureButton_mouseDownHandler(event);
    }
}
declare module eui {
    /**
    ...
    interface IWizard {
         ...
         * 创建向导的容器
         */
        createPageContainer(pageContainer: egret.DisplayObjectContainer): void;
        /**
         * 向导的容器
         */
        container: eui.IWizardContainer;
        /**
         * 向导窗口标题
         */
         ...
         * 是否需要进度监控器
         */
        getNeedsProgressMonitor(): boolean;
        /**
         * 返回下一页
         */
        getNextPage(page: eui.IWizardPage): eui.IWizardPage;
        /**
         * 返回上一页
         */
        getPreviousPage(page: eui.IWizardPage): eui.IWizardPage;
        /**
         * 返回第一页
         */
        getStartingPage(): eui.IWizardPage;
        /**
         * 返回指定名称的向导页
         */
        getPage(pageName: string): eui.IWizardPage;
        /**
         * 返回向导页的数量
         */
        getPageCount(): number;
         ...
         * 按下取消键执行的操作
         */
        performCancel(): boolean;
        /**
         * 按下完成键执行的操作
         */
        performFinish(): boolean;
    }
}
declare module eui {
    /**
     ...
     *
     */
    interface IWizardContainer extends IRunnableContext, egret.IEventDispatcher {
        /**
        * 返回当前的向导页
        */
        getCurrentPage(): IWizardPage;
        /**
         * 显示指定的页
         */
        showPage(page: IWizardPage): void;
        /**
         * 更新按钮显示
         */
        updateButtons(): void;
...
declare module eui {
    ...
    interface IWizardNode {
         ...
         * 返回向导
         */
        getWizard(): eui.IWizard;
        /**
         * 返回节点的向导是否被创建
         */
        getIsContentCreated(): boolean;
    }
}
declare module eui {
    /**
     ...
     *
     */
    interface IWizardPage extends IDialogPage {
        /**
         * 返回是否能翻到下页
         */
         ...
         * 返回页面是否完成
         */
        getIsPageComplete(): boolean;
    }
}
declare module eui {
    /**
         * 向导中显示的页签接口
         * 扩展自<code>IWizardPage</code>
         * 添加<code>doFunction</code>方法,
         * 用于扩展用户点击下一页至跳转至下一页之间
         * 需处理的逻辑,例如在发布界面配置完成后点击下一步
         * 会首先进行编译,至编译完成后调用回调函数表示可以跳转至下一个页签
         * 该接口需配合<code>WizardDialogExtend</code> 或其子类使用
         * @author ys
         *
         */
    interface IWizardPageExtend extends IWizardPage {
        /**
         * 用户点击下一页按钮至跳转下一页之间的逻辑
         * @param finishFuntion 该页签内逻辑完成时的回调函数,finishFuntion():void
         *
         */
        doFunction(finishFuntion: Function): void;
    }
}
declare module eui {
    /**
    ...
    class Wizard implements IWizard {
        ...
        /**
             ...
             */
        private pages;
        private _forcePreviousAndNextButtons;
        /**
         * 即使只有一页向导是否需要上一页和下一页的按钮
         */
        forcePreviousAndNextButtons: boolean;
        /**
         * 添加一个向导页
         */
        ...
        private _needsProgressMonitor;
        getNeedsProgressMonitor(): boolean;
        setNeedsProgressMonitor(value: boolean): void;
        getNextPage(page: IWizardPage): IWizardPage;
        getPreviousPage(page: IWizardPage): IWizardPage;
        getStartingPage(): IWizardPage;
        getPage(pageName: string): IWizardPage;
        getPageCount(): number;
        getPages(): any[];
        needsPreviousAndNextButtons(): boolean;
        performCancel(): boolean;
...
declare module eui {
     ...
     *
     */
    class WizardDialog extends eui.TitleAreaDialog implements IWizardContainer, IRunnableContext {
        constructor(newWidzard: eui.IWizard);
        private _wizard;
        /**
         * 当前的向导
         */
         ...
         * 设置向导
         */
        protected setWizard(value: eui.IWizard): void;
        /**
         * 对话框对应的向导集合
         */
        private createdWizards;
        /**
         * 嵌套的向导
         */
        private nestedWizards;
        private _currentPage;
        /**
         * 当前显示页
         */
        getCurrentPage(): IWizardPage;
        setCurrentPage(value: IWizardPage): void;
        /**
         * 页面的描述
         */
         ...
         */
        private pageMessage;
        private pageMessageType;
        private isMovingToPreviousPage;
        /**
         * 上一页按钮
         */
        private backButton;
         ...
         * 上一步按钮点击
         */
        protected backPressed(): void;
        /**
         * 下一步按钮被点击
         */
        protected nextPressed(): void;
        /**
         * 派发页面即将改变的事件
         */
        private doPageChanging(targetPage);
        protected finishPressed(): void;
        /**
         * 执行嵌套的向导的确认操作，并关闭窗口
         */
        ...
        close(): void;
        private okToClose();
        private createWizardClosingDialog();
        /**
         * @inheritDoc
         */
        protected buttonPressed(name: string): void;
         ...
         * 创建上一步和下一步按钮
         */
        private createPreviousAndNextButtons();
        /**
         * 关闭窗口
         */
        private hardClose();
         ...
         * 更新页面
         */
        private updateForPage(page);
        /**
         * 显示向导开始的页面
         */
        private showStartingPage();
        protected update(): void;
        updateButtons(): void;
        private updateDescriptionMessage();
        updateMessages(): void;
        updateTitleBar(): void;
        updateWindowTitle(): void;
        /**
         * 创建进度条部件
         */
        protected createProgressMonitor(): ProgressMonitorPart;
        /**
         * 正在运行的操作数量
         */
        private activeRunningOperations;
        run(operation: Function, cancelable?: boolean): void;
        protected progressComplete(event: egret.Event): void;
        /**
         * 开始长时间的运行任务，显示进度条禁用按钮
         * @param enableCancelButton 是否可以取消
         */
        private aboutToStart(enableCancelButton);
        private savedState;
        private saveUIState(keepCancelEnabled);
        private restoreUIState();
        private restoreEnableState(display, key);
        private saveEnableStateAndSet(display, key, value);
        /**
         * 停止任务
         */
        private stopped();
...
declare module eui {
     ...
     *
     */
    class WizardPage extends eui.DialogPage implements eui.IWizardPage {
        constructor();
        canFlipToNextPage(): boolean;
        private _pageName;
        getPageName(): string;
        setPageName(value: string): void;
        getNextPage(): eui.IWizardPage;
        private _previousPage;
        previousPage: eui.IWizardPage;
        /**
         * 返回是否是当前页
         */
        protected getIsCurrentPage(): boolean;
        private _isPageComplete;
        getIsPageComplete(): boolean;
        setIsPageComplete(value: boolean): void;
        setDescription(value: string): void;
        setErrorMessage(value: string): void;
        setMessage(value: string, type?: number): void;
        setTitle(value: string): void;
         ...
         * 返回向导页对应的容器
         */
        protected container: eui.IWizardContainer;
    }
}
declare module eui {
    /**
     ...
     *
     */
    class WizardSelectionPage extends WizardPage {
        constructor();
        private _selectedNode;
        /**
         * 选中的向导节点
         */
        selectedNode: eui.IWizardNode;
        /**可选的向导节点*/
        private selectedWizardNodes;
        /**
         * 添加可选节点到列表
         */
        private addSelectedNode(node);
        canFlipToNextPage(): boolean;
        getNextPage(): eui.IWizardPage;
    }
}
declare module eui {
    ...
    interface IRunnableContext {
        ...
        /**
         * 执行任务
         * @param operation 要执行的操作 function(monitor:IProgressMonitor):void{};
...
declare module eui {
     ...
     *
     */
    interface IProgressMonitor extends egret.IEventDispatcher {
        /**
         * 开始主任务
         * @param name 主任务的描述
         * @param totalWork 主任务的执行命令的总数量
         * 如果是0则表示数量是未知的
         */
        beginTask(name: string, totalWork: number): void;
        /**
         * 完成，无论是主任务完成还是用户取消了。这个方法有可能被调用多次
         * @param preventDefault 是否取消默认行为
         */
        done(preventDefault: boolean): void;
        /**
         * 内部方法
         * @param work 命令完成的数量
         */
        internalWorked(work: number): void;
        /**
         * 任务是否被取消了
         */
        canceled: boolean;
        ...
        /**
         * 通知给定数量的命令已经完成，这个数字不是累加的结果而是分期的
         * @param work 上次完成的数量
         */
...
declare module eui {
     ...
     *
     */
    interface IProgressMonitorWithBlocking extends IProgressMonitor {
        /**
         * 设置阻塞
         */
...
declare module eui {
     ...
     *
     */
    class ProgressIndicator extends eui.Component {
        constructor();
        private _direction;
        /**
         ...
         * 开始播放动画
         */
        beginAnimatedTask(): void;
        /**
         * 开始 max表示最大数
         */
        beginTask(max: number): void;
        /**
         * 完成
         */
        done(): void;
         ...
         * 移动进度指示器到末尾
         */
        sendRemainingWork(): void;
        /**
         * 增加指定的进度
         */
        worked(work: number): void;
        progressLoopBar: eui.ProgressLoopBar;
        progressBar: eui.ProgressBar;
        protected partAdded(partName: string, instance: Object): void;
        private setProgressBar(bar, visible);
    }
    /**
     * 定义进度条控件增长方向的常量
     * @author dom
...
declare module eui {
    class ProgressLoopBar extends eui.Component {
        constructor();
        visible: boolean;
        private _direction;
        direction: string;
        ...
        wait(): void;
        restart(): void;
        private thumbPercent;
        private startAnimate(event?);
        private stopAnimate(event?);
        private startTime;
        private doAnimate(event);
        thumb: egret.DisplayObject;
        track: egret.DisplayObject;
        protected updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
...
declare module eui {
     ...
     *
     */
    class ProgressMonitorPart extends eui.Component implements IProgressMonitorWithBlocking {
        constructor();
        /**
         * 任务名称
         */
         ...
         * 是否创建停止按钮
         */
        createStopButton: boolean;
        private _cancelComponent;
        /**
         * 执行取消的组件，如果不设置并且createStopButton为true则使用stopButton取消
         */
        cancelComponent: eui.Component;
        protected cancelClick(event: egret.MouseEvent): void;
        /**
         * 进度指示器
         */
        progressIndicator: eui.ProgressIndicator;
        stopButton: eui.Button;
        ...
        private taskLabel();
        worked(work: number): void;
        private setCancelEnabled(enabled);
    }
}
declare module eui {
    class AddPosition extends egret.HashObject {
        static TOP: string;
        static LEFT: string;
        static RIGHT: string;
...
declare module eui {
    interface IToolTip extends eui.Component {
        toolTipData: any;
    }
}
declare module eui {
...
declare module eui {
    class BoxContainerEvent extends egret.Event {
        static BOX_DRAG_COMPLETE: string;
        static DRAG_PANEL_OUT: string;
        static DRAG_GROUP_MOVED: string;
        static DRAG_PANEL_MOVED: string;
        static DRAG_GROUP_IN: string;
        static BOX_ADDED: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean);
        fromPanel: eui.ITabPanel;
        fromPanelIndex: number;
        toPanel: eui.ITabPanel;
        toPanelIndex: number;
        fromGroup: eui.IBoxElement;
        toGroup: eui.IBoxElement;
        toGroupPosititon: string;
    }
}
declare module eui {
    /**
     ...
     * @author featherJ
     */
    class CloseTabEvent extends egret.Event {
        /**
         * 关闭当前
         */
        static CLOSE: string;
         ...
         * 关闭其他
         */
        static CLOSE_OTHER: string;
        /**
         * 关闭全部
         */
        static CLOSE_ALL: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean);
    }
}
declare module eui {
...
declare module eui {
    class CollectionEventKindEX extends egret.HashObject {
        static ADD: string;
        static MOVE: string;
        static REFRESH: string;
        static REMOVE: string;
...
declare module eui {
    class DocumentEvent extends egret.Event {
        static SELECTED_DOC_CHANGE: string;
        static DOC_FOCUS_IN: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean);
        newData: eui.IDocumentData;
        oldData: eui.IDocumentData;
        clone(): egret.Event;
    }
}
declare module eui {
    class DragEvent extends egret.MouseEvent {
        static DRAG_START: string;
        static DRAG_COMPLETE: string;
        static DRAG_DROP: string;
        static DRAG_ENTER: string;
        static DRAG_EXIT: string;
        static DRAG_OVER: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, dragInitiator?: egret.DisplayObject, dragSource?: DragSource, ctrlKey?: boolean, altKey?: boolean, shiftKey?: boolean);
...
declare module eui {
    class GridCaretEvent extends egret.Event {
        static CARET_CHANGE: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, oldRowIndex?: number, oldColumnIndex?: number, newRowIndex?: number, newColumnIndex?: number);
        oldRowIndex: number;
    ...
    class GridEvent extends egret.MouseEvent {
        ...
        */
        ...
        /**
          ...
          *
          */
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, localX?: number, localY?: number, relatedObject?: any, ctrlKey?: boolean, altKey?: boolean, shiftKey?: boolean, buttonDown?: boolean, delta?: number, rowIndex?: number, columnIndex?: number, column?: eui.GridColumn, item?: any, itemRenderer?: eui.IGridItemRenderer, commandKey?: boolean, controlKey?: boolean);
        /**
...
declare module eui {
    class GridItemEditorEvent extends egret.Event {
        static GRID_ITEM_EDITOR_SESSION_STARTING: string;
        static GRID_ITEM_EDITOR_SESSION_START: string;
        static GRID_ITEM_EDITOR_SESSION_SAVE: string;
        static GRID_ITEM_EDITOR_SESSION_CANCEL: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, rowIndex?: number, columnIndex?: number, column?: eui.GridColumn);
        columnIndex: number;
        column: eui.GridColumn;
        rowIndex: number;
        clone(): egret.Event;
...
declare module eui {
    class GridSelectionEvent extends egret.Event {
        static SELECTION_CHANGE: string;
        static SELECTION_CHANGING: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, kind?: string, selectionChange?: eui.CellRegion);
        kind: string;
        selectionChange: eui.CellRegion;
        toString(): string;
        clone(): egret.Event;
    }
}
declare module eui {
    class GridSelectionEventKind extends egret.HashObject {
        static SELECT_ALL: string;
        static CLEAR_SELECTION: string;
        static SET_ROW: string;
        static ADD_ROW: string;
        static REMOVE_ROW: string;
        static SET_ROWS: string;
        static SET_CELL: string;
        static ADD_CELL: string;
        static REMOVE_CELL: string;
        static SET_CELL_REGION: string;
    }
}
declare module eui {
    class GridSortEvent extends egret.Event {
        static SORT_CHANGE: string;
        static SORT_CHANGING: string;
        constructor(type: string, bubbles: boolean, cancelable: boolean, column: eui.GridColumn);
        column: eui.GridColumn;
        clone(): egret.Event;
    }
}
declare module eui {
    class IndexChangeEvent extends egret.Event {
...
declare module eui {
    class PropertyChangeEvent extends egret.Event {
        static PROPERTY_CHANGE: string;
        static createUpdateEvent(source: any, property: any, oldValue: any, newValue: any): eui.PropertyChangeEvent;
...
declare module eui {
    class TabGroupEvent extends egret.Event {
        static MAXIMIZED: string;
        static MINIMIZED: string;
        static CLOSE_static_egret_ui_events_TabGroupEvent: string;
        static CLOSING_PANEL: string;
        static PANEL_OPENED: string;
        static PANEL_CREATED: string;
        static CLOSE_PANEL: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean);
        clone(): egret.Event;
        relateObject: any;
        relatePanel: eui.ITabPanel;
    }
}
declare module eui {
    class ToolTipEvent extends egret.Event {
        static TOOL_TIP_HIDE: string;
        static TOOL_TIP_SHOW: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean, toolTip?: eui.IToolTip);
        toolTip: eui.IToolTip;
        clone(): egret.Event;
    }
}
declare module eui {
    class TrackBaseEvent extends egret.Event {
...
declare module eui {
     ...
     * @author featherJ
     */
    class TreeDragEvent extends egret.Event {
        /**
         * 拖拽进入完成了
         */
        static ITEMS_DRAG_IN_COMPLETE: string;
        /**
         * 拖拽开始
         */
        static ITEMS_DRAG_START: string;
        /**
         * 拖拽移动结束了
         */
        static ITEMS_DRAG_MOVE_COMPLETE: string;
        constructor(type: string, bubbles?: boolean, cancelable?: boolean);
        /**
         * 被拖拽的数据项列表
         */
...
declare module eui {
     ...
     * @author featherJ
     */
    class TreeEvent extends egret.Event {
        /**
         ...
         */
        static dispatchTreeEvent(target: egret.IEventDispatcher, type: string, itemIndex?: number, item?: any, itemRenderer?: ITreeItemRenderer, opening?: boolean, bubbles?: boolean, cancelable?: boolean): boolean;
        clean(): void;
    }
}
declare module eui {
...
declare module eui {
    class ScrollBasicLayout extends eui.BasicLayout {
        constructor();
        protected getElementBoundsLeftOfScrollRect(scrollRect: egret.Rectangle): egret.Rectangle;
        protected getElementBoundsRightOfScrollRect(scrollRect: egret.Rectangle): egret.Rectangle;
        protected getElementBoundsAboveScrollRect(scrollRect: egret.Rectangle): egret.Rectangle;
        protected getElementBoundsBelowScrollRect(scrollRect: egret.Rectangle): egret.Rectangle;
    }
}
declare module eui {
    class AccordionLayout extends eui.ScrollBasicLayout {
        constructor();
        measure(): void;
        updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
    }
...
declare module eui {
     ...
     *
     */
    class AttributeQueueLayout extends LayoutBase {
        constructor();
        /**
         * 横向间隔
         */
...
declare module eui {
    class GridLayout extends eui.LayoutBase {
        gridDimensions: eui.GridDimensions;
        private visibleRowIndices;
        private visibleColumnIndices;
        private oldVisibleRowIndices;
        private oldVisibleColumnIndices;
        private visibleRowBackgrounds;
        private visibleRowSeparators;
        private visibleColumnSeparators;
        private visibleItemRenderers;
        private hoverIndicator;
        private caretIndicator;
        private editorIndicator;
        private visibleItemRenderersBounds;
        private visibleGridBounds;
        private freeElementMap;
        private elementToFactoryMap;
        private oldVerticalScrollPosition;
        private oldHorizontalScrollPosition;
        static _embeddedFontRegistryExists: boolean;
        static embeddedFontRegistryExistsInitialized: boolean;
        constructor();
        useVirtualLayout: boolean;
        private _showCaret;
        showCaret: boolean;
        ...
        measure(): void;
        updateDisplayList(unscaledWidth: number, unscaledHeight: number): void;
        private updateVisibleItemRenderers();
        private grid;
        private getLayer(name);
        private getGridColumn(columnIndex);
        private getDataProviderItem(rowIndex);
        private static clampColumnWidth(width, column);
        private createTypicalItemRenderer(columnIndex);
        private updateVisibleTypicalCellSizes(width, scrollX, firstVisibleColumnIndex);
        private updateTypicalCellSizes();
        private layoutColumns(scrollX, scrollY, width);
        private gridItemRendererClassFactories;
        private itemToRenderer(column, dataItem);
        private layoutItemRenderers(rendererLayer, scrollX, scrollY, width, height);
        invalidateCell(rowIndex: number, columnIndex: number): void;
        private itemRendererFunctionValueChanged(renderer);
        private getVisibleItemRendererIndex(rowIndex, columnIndex);
        getVisibleItemRenderer(rowIndex: number, columnIndex: number): eui.IGridItemRenderer;
        private takeVisibleItemRenderer(rowIndex, columnIndex);
        private initializeItemRenderer(renderer, rowIndex, columnIndex, dataItem?, visible?);
        private freeItemRenderer(renderer);
        private freeItemRenderers(renderers);
        private layoutLinearElements(factory, layer, oldVisibleElements, oldVisibleIndices, newVisibleIndices, layoutFunction, _owner, lastIndex?);
        private layoutCellElements(factory, layer, oldVisibleElements, oldVisibleRowIndices, oldVisibleColumnIndices, newVisibleRowIndices, newVisibleColumnIndices, layoutFunction);
        private discardGridElementsIfFactoryChanged(factory, layer, oldVisibleElements);
        private freeLinearElements(elements, oldIndices, newIndices, lastIndex);
        private freeCellElements(elements, newElements, oldRowIndices, newRowIndices, oldColumnIndices, newColumnIndices);
        private layoutRowBackground(rowBackground, rowIndex);
        private layoutRowSeparator;
        private layoutColumnSeparator;
        private visibleSelectionIndicators;
        private visibleRowSelectionIndices;
        private visibleColumnSelectionIndices;
        private isRowSelectionMode();
        private isCellSelectionMode();
        private layoutSelectionIndicators(layer);
        private layoutRowSelectionIndicator;
        private layoutCellSelectionIndicator;
        private clearSelectionIndicators();
        private layoutIndicator(layer, indicatorFactory, indicator, rowIndex, columnIndex);
        private mouseXOffset;
        private mouseYOffset;
        private layoutHoverIndicator(layer);
        private layoutCaretIndicator(layer);
        private layoutEditorIndicator(layer);
        dataProviderCollectionChanged(event: eui.CollectionEvent): void;
        private dataProviderCollectionAdd(event);
        private dataProviderCollectionRemove(event);
        private incrementIndicesGTE(indices, insertIndex, delta);
        private dataProviderCollectionReset(event);
        private dataProviderCollectionUpdate(event);
        columnsCollectionChanged(event: eui.CollectionEvent): void;
        private createdGridElement;
        private createGridElement(factory);
        private allocateGridElement(factory);
        private freeGridElement(element);
        private freeGridElements(elements);
        private removeGridElement(element);
        private layoutItemRenderer(renderer, x, y, width, height);
        private layoutGridElementR(elt, bounds);
        static MAX_ELEMENT_SIZE: number;
        static ELEMENT_EDGE_PAD: number;
        private layoutGridElement(elt, x, y, width, height);
        private intializeGridVisualElement(elt, rowIndex?, columnIndex?);
        getVisibleRowIndices(): Array<number>;
        getVisibleColumnIndices(): Array<number>;
        getCellBounds(rowIndex: number, columnIndex: number): egret.Rectangle;
        getRowBounds(rowIndex: number): egret.Rectangle;
        ...
        getItemRendererAt(rowIndex: number, columnIndex: number): eui.IGridItemRenderer;
        isCellVisible(rowIndex: number, columnIndex: number): boolean;
        private _performanceStatistics;
        performanceStatistics: any;
        private _enablePerformanceStatistics;
        enablePerformanceStatistics: boolean;
    }
}
declare module eui {
    /**
...
declare module eui {
    ...
    class VerticalLayout extends LinearLayoutBase {
         ...
         * 确定根据 NavigationUnit、基于当前处于焦点的项目和用户输入要导航到哪个项目的委派方法
         */
        getNavigationDestinationIndex(currentIndex: number, navigationUnit: number, loop?: boolean): number;
        /**
         * @inheritDoc
         */
        getElementBounds(index: number): egret.Rectangle;
         ...
         */
        typicalLayoutRect: egret.Rectangle;
        /**
         * 如果指定的索引完全在视图中，则返回 1.0；如果不在视图中，则返回 0.0；
         * 如果部分处于视图中，则返回在 0.0 和 1.0 之间的一个值（表示处于视图中的部分的百分比）。
         */
        fractionOfElementInView(index: number): number;
    }
}
declare module eui {
    class DragManager extends egret.HashObject {
        static _impl: IDragManager;
        private static implMap;
        private static getImpl(target);
        private impl;
        static getIsDragging(dragInitiator: egret.DisplayObject): boolean;
        static setIsDragging(dragInitiator: egret.DisplayObject, value: boolean): void;
        static doDrag(dragInitiator: egret.DisplayObject, dragSource: DragSource, dragImage?: egret.DisplayObject, xOffset?: number, yOffset?: number, imageAlpha?: number): void;
        static acceptDragDrop(target: egret.DisplayObject): void;
        static endDrag(target?: egret.DisplayObject): void;
    }
}
declare module eui {
    class DragManagerImpl extends egret.HashObject implements IDragManager {
        constructor();
        ...
        doDrag(dragInitiator: egret.DisplayObject, dragSource: DragSource, dragImage?: egret.DisplayObject, xOffset?: number, yOffset?: number, imageAlpha?: number): void;
        acceptDragDrop(target: egret.DisplayObject): void;
        endDrag(): void;
    }
}
declare module eui {
    class DragProxy extends eui.Component {
        onUnderPointDisable: Function;
        onUnderPointEnable: Function;
        onExit: Function;
        constructor(dragInitiator: egret.DisplayObject, dragSource: DragSource);
        protected createChildren(): void;
        ...
        private dispatchDragEvent(type, mouseEvent, eventTarget);
        private oldTarget;
        private mouseMoveHandler(event);
        private mouseLeaveHandler(event);
        private mouseUpHandler(event);
        private effectEndHandler();
        private static getObjectsUnderPoint(obj, pt, arr);
        endDrag(): void;
    }
}
declare module eui {
    class DragSource extends egret.HashObject {
        constructor();
        private dataHolder;
        private formatHandlers;
        private _formats;
        formats: Array<any>;
        addData(data: any, format: string): void;
        addHandler(handler: Function, format: string): void;
        dataForFormat(format: string): any;
...
declare module eui {
    ...
    class FocusManager implements IFocusManager {
         ...
         * 屏蔽FP原始的焦点处理过程
         */
        private mouseFocusChangeHandler(event);
        /**
         * 当前的焦点对象。
       */
       ...
       */
         ...
         * 获取鼠标按下点的焦点对象
       */
        private getTopLevelFocusTarget(target);
        /**
         * 窗口激活时重新设置焦点
       */
...
declare module eui {
    interface IDragManager {
        getIsDragging(): boolean;
        setIsDragging(value: boolean): any;
        doDrag(dragInitiator: egret.DisplayObject, dragSource: eui.DragSource, dragImage?: egret.DisplayObject, xOffset?: number, yOffset?: number, imageAlpha?: number): any;
        acceptDragDrop(target: egret.DisplayObject): any;
        endDrag(): any;
    }
}
declare module eui {
    ...
    class PopUpManager {
         ...
         * 返回是否成功添加
         */
        static popUp(panel: egret.DisplayObject, parent: egret.DisplayObjectContainer, isMid?: boolean, isModal?: boolean): boolean;
        /**
         * 移除弹出项
         * @param panel
         *
         ...
         *
         */
        static removePopup(panel: egret.DisplayObject): boolean;
    }
}
declare module eui {
    /**
    ...
    class PopUpManagerImpl {
         ...
         * @param isModal 是否模态
         */
        popUp(panel: egret.DisplayObject, parent: egret.DisplayObjectContainer, isMid?: boolean, isModal?: boolean): boolean;
        private getMask(popupdata);
        /**
         * 避免弹出项被外部移除
         * 模态无法自动移除
         * @param e
         */
        private removeByOther(e);
        private removePopUpListener(popup);
        /**
         * 获取一个初始化完成后的弹出数据项
         * @param popUp
         */
        private getInitPopUpData(popUp);
        private getDataByPopup(popUp);
        private deleteData(data);
        /**
         * 移除弹出的面板
         * @param panel
         */
        removePopup(panel: egret.DisplayObject | PopUpData): boolean;
    }
    class PopUpData {
        popUp: egret.DisplayObject;
        popUpParent: egret.DisplayObjectContainer;
        mask: eui.Rect;
    }
    class MaskData {
        color: number;
...
declare module eui {
    class BoxElementIdUtil extends egret.HashObject {
        static idArr: Array<any>;
        static newId(): number;
        private static checkHas(id);
...
declare module eui {
    class MouseEventUtil extends egret.HashObject {
        static addDownDragUpListeners(target: egret.DisplayObject, handleDown: Function, handleDrag: Function, handleUp: Function): void;
    }
}
declare module egret {
    module utils {
        function tr(key: string, ...args: any[]): string;
    }
}
