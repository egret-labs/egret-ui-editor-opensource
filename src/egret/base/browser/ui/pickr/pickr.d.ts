export default class Pickr {
	...
	getSelectedColor(): HSVaColor;

	destroy(): void;

	destroyAndRemove(): void;

	setColorRepresentation(type: Representation): boolean;

	getColorRepresentation(): Representation;
