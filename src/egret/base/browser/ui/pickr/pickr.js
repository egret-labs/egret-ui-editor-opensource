...
function() {
    ...
    function(t, e, n) {
        ...
        n.d(o, "createElementFromString",
        function() {
            return l
        }),
        n.d(o, "removeAttribute",
        function() {
            return p
        }),
        n.d(o, "createFromTemplate",
        function() {
            return d
        }),
        n.d(o, "eventPath",
        ...
        function u(t, e, n, o) {
            ...
            return e instanceof HTMLCollection || e instanceof NodeList ? e = Array.from(e) : Array.isArray(e) || (e = [e]),
            Array.isArray(n) || (n = [n]),
        ...
        function f(t) {
            ...
            function o(o) {
                ...
                a = i,
                c = "",
                s = i - 1; s > 0 && n(r[s]); s--) c = r[s] + c,
                a--;
                for (var u = i,
                l = r.length; u < l && n(r[u]); u++) c += r[u];
                if (c.length > 0 && !isNaN(c) && isFinite(c)) {
                    var p = o.deltaY < 0 ? 1 : -1,
                    d = o.ctrlKey ? 5 * p: p,
                    h = Number(c) + d; ! e && h < 0 && (h = 0);
        ...
        function k(t, e, n) {
            ...
            return 0 !== o && (e = 1 === o ? 0 : o < .5 ? e * n / (2 * o) : e * n / (2 - 2 * o)),
            [t, 100 * e, 100 * o]
        }
        function A(t, e, n) {
        ...
        function C(t, e, n, o) {
            return e /= 100,
            n /= 100,
            y(A(255 * (1 - g(1, (t /= 100) * (1 - (o /= 100)) + o)), 255 * (1 - g(1, e * (1 - o) + o)), 255 * (1 - g(1, n * (1 - o) + o))))
        }
        function S(t, e, n) {
            return e /= 100,
            [t, 2 * (e *= (n /= 100) < .5 ? n: 1 - n) / (n + e) * 100, 100 * (n + e)]
        }
        function O(t) {
        ...
        function j(t) {
            ...
            for (var r in n) if (e = n[r].exec(t)) switch (r) {
            case "cmyk":
                var i = v(o(e), 5),
                a = i[1],
                c = i[2],
        ...
        function E(t) {
            var e = {
                ...
                destroy: function() {
                    var t = e.options,
                    n = e._tapstart;
                    s([t.wrapper, t.element], "mousedown", n),
                    s([t.wrapper, t.element], "touchstart", n, {
                        passive: !1
                    })
                }
            };
            ...
            var n = e.options,
            o = e._tapstart;
            return c([n.wrapper, n.element], "mousedown", o),
            c([n.wrapper, n.element], "touchstart", o, {
                passive: !1
            }),
            e
        }
        ...
        var B = function() {
            ...
            return function(t, e, n) {
                ...
                value: function() {
                    var t = this.options;
                    "string" == typeof t.el && (t.el = document.querySelector(t.el)),
                    ...
                    t.useAsButton && (t.parent || (t.parent = "body"), this._root.button = t.el),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    t.parent && ("string" == typeof t.parent && (t.parent = document.querySelector(t.parent)), t.parent.appendChild(e.app)),
                    ...
                    n = {
                        palette: E({
                            ...
                            onchange: function(e, n) {
                                ...
                                i.comparison || (r.button.style.background = a, i.useAsButton || (r.preview.lastColor.style.background = a)),
                        ...
                        selectable: function() {
                            ...
                            return c(e.options.elements, "click", e._ontap),
                            e
                        } ({
            ...
            },
            {
                ...
                value: function() {
                    ...
                    e = this._root,
                    n = this.options,
                    o = [c(e.interaction.clear, "click",
                    function() {
                        return t._clearColor()
                    }), c(e.preview.lastColor, "click",
                    function() {
                        return t.setHSVA.apply(t, H(t._lastColor.toHSVA()))
                    }), c(e.interaction.save, "click",
                    function() { ! t._saveColor() && !n.showAlways && t.hide()
                    }), c(e.interaction.result, ["keyup", "input"],
                    function(e) {
                        t._recalc = !1,
                        t.setColor(e.target.value, !0) && !t._initializingActive && t.options.onChange(t._color, t),
                        e.stopImmediatePropagation()
                    }), c([e.palette.palette, e.palette.picker, e.hue.slider, e.hue.picker, e.opacity.slider, e.opacity.picker], ["mousedown", "touchstart"],
                    function() {
                        return t._recalc = !0
                    }), c(window, "resize",
                    function() {
                    ...
                    n.adjustableNumbers && f(e.interaction.result, !1),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    "middle" !== this.options.position && (u < 0 && -u < r.width / 2 || l > window.innerWidth && l - window.innerWidth < r.width / 2) ? s = a.middle: u < 0 ? s = a.right: l > window.innerWidth && (s = a.left),
                    i.left = "".concat(s, "px")
                }
            },
            {
            ...
            },
            {
                ...
                value: function() {
					var e = this.options;
					e.onCancel && e.onCancel(this);
                    return this._root.app.classList.remove("visible");
                }
            },
            {
                key: "show",
                value: function() {
					var e = this.options;
                    if (!this.options.disabled) return (e.onCancel && e.onDisplay(this)),this._root.app.classList.add("visible"),
                    this._rePositioningPicker(),
                    this
                }
            },
            ...
            },
            {
                ...
                value: function(t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                    if (null === t) return this._clearColor(),
                    !0;
                    var n = j(t),
                    o = n.values,
                    r = n.type;
