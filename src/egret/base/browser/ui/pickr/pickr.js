/*! Pickr 1.5.1 MIT | https://github.com/Simonwep/pickr */ ! function (t, e) {
	...
	return function (t) {
		...
		function m(t, e = (t => t)) {
			...
			a(t, "focus", () => a(window, "wheel", o, {
				passive: !1
			})), a(t, "blur", () => l(window, "wheel", o))
		}
		var v = o(0);
		const {
			min: b,
		...
		class R {
			...
			_bindEvents() {
				const {
					_root: t,
					options: e
				} = this, o = [a(t.interaction.clear, "click", () => this._clearColor()), a([t.interaction.cancel, t.preview.lastColor], "click", () => {
