...
export class DataBindingUtil {
	...
	public static getFinalValueAfterReplaceByBindingData(value, editModel: ExmlModelConfig): { value: any, isReplacedByTestData: boolean } {
		if (!types.isString(value)) {
			return { value: value, isReplacedByTestData: false };
		}
		// let globalTestData = editModel.getProjectConfig().;
		// let selfTestData = editModel.bindingDataTestObj;
